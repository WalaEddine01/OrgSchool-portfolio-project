...
-- Create database + admin if doesn't exist
...
CREATE TABLE `cities` (
  ...
  CONSTRAINT `cities_ibfk_1` FOREIGN KEY (`class_id`) REFERENCES `classs` (`id`)
) ENGINE = InnoDB DEFAULT CHARSET = latin1;
/*!40101 SET character_set_client = @saved_cs_client */
;
--
...
UNLOCK TABLES;
--
-- Table structure for table `school_amenity`
--

DROP TABLE IF EXISTS `school_amenity`;
/*!40101 SET @saved_cs_client     = @@character_set_client */
;
/*!40101 SET character_set_client = utf8 */
;
CREATE TABLE `school_amenity` (
  `school_id` varchar(60) NOT NULL,
  `amenity_id` varchar(60) NOT NULL,
  PRIMARY KEY (`school_id`, `amenity_id`),
  KEY `amenity_id` (`amenity_id`),
  CONSTRAINT `school_amenity_ibfk_1` FOREIGN KEY (`school_id`) REFERENCES `schools` (`id`),
  CONSTRAINT `school_amenity_ibfk_2` FOREIGN KEY (`amenity_id`) REFERENCES `amenities` (`id`)
) ENGINE = InnoDB DEFAULT CHARSET = latin1;
/*!40101 SET character_set_client = @saved_cs_client */
;
--
-- Dumping data for table `school_amenity`
--

LOCK TABLES `school_amenity` WRITE;
/*!40000 ALTER TABLE `school_amenity` DISABLE KEYS */
;
INSERT INTO `school_amenity`
VALUES (
...
/*!40000 ALTER TABLE `school_amenity` ENABLE KEYS */
;
UNLOCK TABLES;
--
...
CREATE TABLE `schools` (
  ...
  CONSTRAINT `schools_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `cities` (`id`),
  CONSTRAINT `schools_ibfk_2` FOREIGN KEY (`admin_id`) REFERENCES `admins` (`id`)
) ENGINE = InnoDB DEFAULT CHARSET = latin1;
/*!40101 SET character_set_client = @saved_cs_client */
;
--
...
VALUES (
  ...
  (
    ...
    'Private walk-out studio off beautiful backyard with mini kitchen, sauna, jetted tub, fireschool and your own laundry facilities. In the heart of the student, we are close to bus routes, National Jewish Hospital, Rose Medical Center and Cherry Creek Shopping District. An easy three miles west to downtown.<BR /><BR />It is cozy and yet has a number of creature comforts, including a Casper mattress (No. 1 rated by Consumer Report), a great soaking tub, an indoor sauna, heated tile floor in bathroom, fireschool, and a rain shower type shower head.<BR /><BR />The space is very self-contained, with its own private entrance, laundry facilities, bathroom, kitchen, outside sitting area and more, but guests can make use of the large backyard, deck, and additional sitting area.<BR /><BR />I really enjoy interacting with people but realize each guest will have his or her own natural preferences in that regard or priorities based upon the purpose of the trip. I am able to run the gamut from remaining av',
    0,
    1,
    2,
    75,
  ...
  (
    ...
    'Enjoy South Beach in one of the best locations in my clean, quiet & remodeled studio!<BR /><BR />You\'re only 2 blocks from the beach and 1 block from fashionable retailers, restaurants, bars, convenience stores, bike rentals & parking structure! <BR /><BR />FREE WiFi!<BR /><BR />My school is close to News Cafe, Wet Willie\'s, Otentic Fresh Food Restaurant, Cafe Del Mar, and Larios on the Beach. My school is good for couples and solo adventurers.<BR /><BR />My condo is permitted under a condo hotel license available at check in.<BR /><BR />Enjoy the convenience of a great location in a clean and quiet updated studio! The building is no frills, but you can\'t beat the location for the price. It\'s located on the calm side of a hotel - which also means you get access to a 24 hours front desk ( say you lost your key at the beach...).<BR /><BR />It\'s just been tastefully renovated too! While it is 270 sqft, you can comfortably enjoy a luxurious queen size bed ( 3 inch memory foam topper mattress',
    0,
    1,
    2,
    89,
  ...
  (
    ...
    'Welcome to Capital Hill!!  You’ll love the hip neighborhood, the comfy bed, the big couch, and the full kitchen.  This is a very quiet 3rd floor corner apt with one parking spot just outside!!! Fresh roasted craft coffee and continental style breakfast included.  My school is excellent for couples, or solo adventurers, and its Dog friendly too!<BR /><BR />The cozy 3rd floor unit comfortably sleeps two, but there is a 7 foot Room&Board couch that is a good option for a 3rd guest.  The bedroom has a full size deep memory foam mattress.   My home has both a full bathroom and large kitchen perfect for cooking meals.<BR /><BR />The entire school is yours.  The wifi,tv, kitchen, parking spot, and basement laundry are accessible.  An 88 key Digital piano with plenty of songbooks is there for the musical type.  I roast my own coffee so try some!  I try to keep the fridge stocked with some yogurt and fruit.  Help yourself.<BR /><BR />The entire space is yours. I respect your privacy and trust tha',
    1,
    1,
    2,
    80,
  ...
  (
    ...
    'The guest house is located uptown two blocks from Tulane U. The house is located in a very safe and convenient location. The house has a private entrance and patio space. The house also has access to a large backyard with a charcoal grill which is shared. This is a simple, clean and affordable school to stay while visiting New Orleans. We provide everything travelers need. Please contact me if you have any questions.<BR />Thanks,<BR />Ryan<BR /><BR />Note: We have a $50 pet fee',
    0,
    1,
    2,
    60,
  ...
  (
    ...
    'My school is just a short walk to downtown and everything Bisbee has to offer; art, restaurants and bars, antiques and attractions. There is off street parking. My school is perfect for a couple or individual.',
    0,
    1,
    2,
    75,
  ...
  (
    ...
    'You’ll love my school because of the neighborhood, the comfy bed, couches ,and the ambiance . You\'ll have FREE Cable & Internet AmazonFire and RokuExpress.Free Washing & Drying only for guest staying more than one night. My school is good for couples, solo adventurers, business travelers and furry friends (pets)<BR /><BR />This includes BOTH living and bedroom with no sharing the bathroom with other guest because you\'ll be the only guest !<BR />Apartment is on third floor. Stairs only <BR />One room with queen bed and living room with two sectionals . Covers and pillows provided. The sectional is a couch so don\'t expect a pillow top mattress setting .<BR />Comcast cable , wifi , On demand , Starz, HBO, Showtime, X1 dvr recording . Jailbroken Amazon Fire in livingroom and Roku express in bedroom .<BR />Free washing and drying clothes only if staying more than one night<BR />Down the street from Rite Aid, Freds, Hair Salons, Gas Station, Subway, Banks,etc.<BR />3-5 mins from interclass <BR',
    1,
    1,
    4,
    36,
  ...
  (
    ...
    'Reason for low price is because this is under promotion right now. limited time promotion for this NEW listing. pls see other teacher.Very small but cheap private room<BR />very Safe,quiet residential area<BR />The room comes with own toilet and sink (open in the room), shower is not in this room. pls do NOT book if you are not comfortable with the toilet and sink open in the room.<BR />Guest can shower in shared Bathroom (Outside of your room)<BR /><BR />You will be sharing the house with guests in other rooms<BR /><BR />What you MUST Know and accept before Booking:<BR /><BR />1. It is a Partition Room. ( so Not Sound Proof at all, Guest must be quiet All Times, No phone call/ Music/ sound in the room)<BR />2. If you Snore, you cannot book this room <BR />3. there is Electronic Blanket <BR />4. No Window, No Sunshine, No heater = Cold <BR />5. Suitable for guest looking for most basic stay.<BR />6.  There is just a Bed & a chair , nothing else, no table<BR />7.  No public living areas ',
    1,
    1,
    1,
    22,
  ...
  (
    ...
    '3ea61b06-e22a-459b-bb96-d900fb8f843a',
    'Home away from home',
    'My entire basement is available.  There is a private bedroom, bathroom and family room.  Guest is welcome to us newly remodeled kitchen.  I am often in the student and not home much except for weekends.  Non-smoker is a must! <BR />My school is close to Highways shopping restaurants.<BR /><BR />It\'s a cozy little home that feels like you are going n vacation.  It\'s isn\'t brand new or fancy but is very comfortable.<BR /><BR />Private bedroom, bathroom, and family room and use of kitchen and laundry room.<BR /><BR />I am not home much.<BR /><BR />I have amazing neighbors and it\'s very peaceful!<BR /><BR />I have a code on the front and back door.',
    4,
    2,
    3,
    85,
  ...
  (
    ...
    'My school is close to family-friendly activities, nightlife, and the student center. You’ll love my school because of the people, the ambiance, and the outdoors space. My school is good for couples, solo adventurers, business travelers, families (with kids), and furry friends (pets).<BR /><BR />As much as needed. Just a phone call away..<BR /><BR />I love this neighborhood because of the neighbors and the activities. The neighbors are so helpful and nice.  Fondren\'s First Thursday\'s is a great way to spend sometime tasting all the local foods and listen to some pretty good bands!',
    2,
    1,
    4,
    99,
  ...
  (
    ...
    'Our school is in North-East Jackson. We are 5 minutes to shopping, parks, and 10-15 minutes from the Health Corridor (UMMC, Baptist, St. Dominics), and downtown. <BR /><BR />You’ll love our school for its gorgeous neighborhood full of old trees. The room is large with a super comfy queen sized bed, private entrance, private full bathroom, sitting area, fridge, microwave, self serve coffee, and a TV for Netflix and HBO. The neighborhood is secure with off-street parking and 24 hour private security patrol.<BR /><BR />Our school is in lovely North-East Jackson. We are within 5 minutes of Whole Foods, Kroger, a 24 hour Walgreen\'s, Planet Fitness, the Willie Morris Library, Parham Bridges Park (with running path and tennis courts), and lots of shopping and restaurants (Highland Village). We are 10-15 minutes from the Health Corridor (University of Mississippi Medical Center, Baptist, St. Dominics), downtown Jackson, Fondren, Bellhaven, County Line Road shopping, Ridgeland, Madison, and Vetera',
    1,
    1,
    2,
    60,
  ...
  (
    ...
    'My school is close to Georgiana,AL-Hank Williams SR. Museum-Interclass 65 AL . You’ll love my school because of the coziness. My school is good for couples, solo adventurers, and business (URL HIDDEN) cabin is a work in progress but it is a nice comfy little school to stay. There is a full bath in the back with shower(the basin of the shower is an old fashioned #2 washtub) ,full size toilet and sink(basin is a little pail).<BR /><BR />Both ends of the cabin are lofted and my plans are to put a bed in each side.As of now the sleeping arrangements consist of a recliner,a couch,and an inflatable mattress.If you are interested in tiny home living,then you should try a night in my cabin.I go up there often just because I like the feel of my tiny home. The kitchen sink is not finished yet but will be soon.There is a nice flatscreen with antenna TV and I also have a pretty good DVD selection there(or just hit a redbox on your way).There is a small fridge,microwave,crock pot, and hotplate as well ',
    0,
    1,
    2,
    56,
  ...
  (
    ...
    'Amazing student view from top floor',
    'Great huge 1 bdr apt with panoramic view in Downtown Chicago. Student view, lake view, river view -all in one!Located on the top floor of a high rise building. All amenities included: gym, swimming pool, tennis court, BBQ deck. 2 blocks away from the famous Magnificent mile. 2 blocks to the Trump tower, 15 min walk to the Cloud gate ( Bean), 10min walk to the Water tower,  walking distance to tons of shops and restaurants. Train and bus station in 1 min walk . Whole Foods, Trader Joe\'s, Jewel Osco in walking distance. Heart of Chicago<BR /><BR />Great huge 1 bdr apt with panoramic view in Downtown Chicago. Student view, lake view, river view -all in one!Located on the top floor of a high rise building. All amenities included: gym, swimming pool, tennis court, BBQ deck. 2 blocks away from the famous Magnificent mile. 2 blocks to the Trump tower, 15 min walk to the Cloud gate ( Bean), 10min walk to the Water tower,  walking distance to tons of shops and restaurants. Train and bus station in 1 ',
    1,
    1,
    3,
    144,
  ...
  (
    ...
    'My school is close to Ft Rucker, parks, the student center.',
    1,
    1,
    2,
    41,
  ...
  (
    ...
    'Congratulations! You\'ve just found the most unique school in downtown Orlando. You will stay in a beautiful suite with private entrance and private bathroom. This hidden oasis features a lake, pool, zen garden, paddle boards and the best view of Downtown Orlando Skyline!<BR /><BR />This two acre property is located just minutes from downtown Orlando. It is truly an urban oasis. The special environment is accomplished by its many gardens, fountains, variety of birds, wildlife, and flowers, the peaceful Lake bordering it, and at night, the dynamic view of the student lights.<BR /><BR />Guests will be given a private code so they can access the gate of the property.<BR /><BR />I will be here to personally greet you, however if I am not available I will leave someone in charge of showing you the property.<BR /><BR />This beautiful property is located in a transitional area of Orlando which is quickly being developed. The student will soon inaugurate a new soccer stadium and a creative village jus',
    1,
    1,
    2,
    69,
  ...
  (
    ...
    'Close to History Colorado Center, La Rumba Salsa Club, Opal Restaurant, Black Eye Coffee, Tony\'s Market, the Sunken Gardens Park, and more! You’ll love my school because the comfy bed, modern kitchen. Located in Denver\'s historic Capitol Hill area, my school has everything you are looking for including a short walk to shopping, dining, and nightlife. My school is great for couples, solo adventurers, and business travelers.<BR /><BR />6th floor modern interior apartment in Denver\'s historic oldest \"high rise\"; Eleanor Roosevelt used to live in our building!<BR /><BR />The entire apartment is yours, and your key fob will get you access to the basement level washer/dryer room, and first floor workout room.<BR /><BR />We may meet you to check you in, and hand over keys.<BR /><BR />Torchy\'s Tacos, La Rumba salsa club, Amethyst Coffee, the Capital building and many museums are within 3-4 blocks walking distance!<BR /><BR />Laundry (washers and dryers) are available in the basement level of th',
    1,
    1,
    3,
    89,
  ...
  (
    ...
    'My school is close to Silver Cross Hospital, I-80, I-355, Forest Preserve (2.5 mile walking loop). You’ll love my school because of the comfy bed, the peacefulness, the view, the outdoors space, the hospitality. My school is good for couples, solo adventurers, spiritual retreaters, and business travelers.<BR />Limited work-out equipment available.<BR /><BR />Fresh garden produce available when in season.',
    1,
    2,
    2,
    60,
  ...
  (
    ...
    'Located in Fondren, my school is 1 block from Jackson\'s best restaurants, art galleries, and shopping!<BR /><BR />Very close to:<BR />Belhaven University<BR />Millsaps College<BR />UMMC, St. Dominics, Baptist <BR />Downtown<BR />Lakeland Drive <BR /><BR />You’ll love my school because it\'s located 1 block from all of the fabulous restaurants, coffee shops, grocery stores, music venues, galleries, boutiques, interior designers , frozen yogurt and popsicle shops, wine bars, and watering holes that the Fondren Neighborhood has to offer<BR /><BR />This apartment is located in a charming old house in the Fondren Neighborhood. The house is divided into 2 separate units, the front (street-facing) unit belonging to a real eclass brokerage.  The two spaces are totally separate from each other with separate entrances, thermostats, security systems, etc. Very private. The office occupants are only there sporadically throughout the weekdays. You likely won\'t notice them as their entrance is on the c',
    2,
    1,
    5,
    119,
  ...
  (
    ...
    'My school is close to The Queen\'s Medical Center, great views, restaurants and dining, the beach, and a bus stop servicing Honolulu. You’ll love my school because of the people, the ambiance, the outdoor space, the neighborhood, the light, and more. My school is good for couples, solo adventurers, and business travelers.',
    1,
    1,
    2,
    39,
  ...
  (
    ...
    'Shared Bunk Room in hostel-type bunkhouse w game room, laundry & no added fees! Great location near Waikiki, beaches, waterfalls, hikes, food, shops, bus & 20 min to airport! Host Lauren manages many listings ensuring great AirBnB experience!<BR /><BR />Discover Oahu from the heart of one of the best locations on island. The setting is just fantastic in this special piece of property with lush views of the mountains and tropical fruit trees. There are three houses on the property and this listing is in the bunkhouse. This is a hostel-type school for travelers long and short term so you will be sharing the entire bunk house with other AirBnb\'ers and travelers. <BR /><BR />Watch the walkthrough video on \"Yoo toob\" by searching Aloha Bunk House or Aloha Bunk (URL HIDDEN) The bunkhouse has three small bunk rooms with one twin bunk bed in each room.<BR /><BR />There is a tiny full kitchen with fridge, microwave, toaster, stove and cooking utensils. There is a shared bathroom with full show',
    1,
    1,
    1,
    30,
  ...
  (
    ...
    'f33e2624-520b-4bc2-b6a0-190ee1d41855',
    'NEW Stylish Cap',
    'Rooftop view of the student. Walking distance to bars, restaurants, grocery & transit. Clean, efficient kitchen, hardwood floors, bathroom with clawfoot tub, queen bed and stylish modern furniture.',
    0,
    1,
    4,
    88,
  ...
  (
    ...
    'Located minutes from downtown Birmingham and convenient to the interclass, this school is the perfect home away from home!  Amazing views, two patios, driveway parking, two master bedrooms, beautiful finishings, and even an upscale kitchen.  Please add us to your favorites!',
    2,
    3,
    7,
    125,
  ...
  (
    ...
    'dfc6b9a5-6673-4f1b-83cd-0dfa800c0d08',
    'Peaceful Paradise',
    'My school is close to nightlife, the airport, family-friendly activities, the student center, and public transport. You’ll love my school because of the light, the comfy bed, the kitchen, the coziness, and the high ceilings. My school is good for couples, solo adventurers, and business travelers.<BR /><BR />I have a two bed room apartment furnished and very spacey...<BR /><BR />You will have access to the entire apartment and amenities and the one master bed room and both bathrooms.  Either I or my room mate may or may not be in the apartment during your stay.<BR /><BR />Yes I will be available for help throughout your stay<BR /><BR />Very pleasant gated community on the best side of town very close to Madison and Ridgeland area<BR /><BR />Very close to public transportation and I could give you a lift if needed',
    2,
    2,
    3,
    59,
  ...
  (
    ...
    'f14fefb3-c6e4-42f6-8a5a-ee704a101f8b',
    '61302be9-4b31-4be0-92fc-d0dda253e167',
    'Student view, Central location, Quiet',
    'Room is next to kitchen with 2 Pocket doors that open/close the space off.  Private bedroom(Daybed with Trundle), private bathroom(5 steps down hallway), shared balcony, living room(has sleeper sofa) and kitchen.  Basic cable, 200mb internet,  pool, sauna,  gym,  7 min to Downtown, 17 min to Galleria Mall, 7 min to i65, i35 and i20, gorgeous student view<BR /><BR />Daybed will sleep one and pull out trundle will sleep 2nd person,  Dresser, drawers in Armoir, and closet for storage,   Iron and ironing board in closet with hangers,  Blowdryer in bathroom under sink.<BR /><BR />Pool, sauna, Gym,  basic cable, high speed internet<BR /><BR />I may or may not be home. Most likely guests do not really see me I try to stay out of the way,   Remy has free roam of school so you will see him more than me.   He is friendly and does not bite, but will try to get snuggles and pets.<BR /><BR />Close to everything,  inbetween a transitioning neighborhood, gas station down the street (shell) and a chevron ',
    1,
    1,
    2,
    55,
  ...
  (
    ...
    'This beautiful vintage home has been completely updated! 10 mins walking distance to Birmingham Southern College, 5-10 mins drive to UAB & St. Vincents Hospitals, the airport, downtown, golfs, parks, some of Birmingham\'s finest restaurants and night life.<BR /><BR />You will love staying in this house, lots of space, FREE parking in the TWO-CAR COVERED GARAGE or on the street, amazing student views from large front covered porch.<BR />Lots space for out of town executives, families for extended visits, wedding groups, Robert Trent Jones Golf groups, and events. Newly and fully renovated, a great high 9 ft.+ ceiling three bedrooms, two full bathroom historical house with large front covered porch furnished with rocking chairs, bench, dining table with chairs, and lots outdoor sitting area. It has two cars covered garage at alley with fenced back yard for easy access to the house without walking on the stairs at front. Large living room with wood burning fireschool and full size sleeper sofa',
    3,
    2,
    10,
    108,
...
CREATE TABLE `teachers` (
  ...
  CONSTRAINT `teachers_ibfk_2` FOREIGN KEY (`admin_id`) REFERENCES `admins` (`id`)
) ENGINE = InnoDB DEFAULT CHARSET = latin1;
/*!40101 SET character_set_client = @saved_cs_client */
;
--
...
VALUES (
  ...
  (
    ...
    '7ed82a23-cd4f-437b-be12-9c54e84281ef',
    '61302be9-4b31-4be0-92fc-d0dda253e167',
    'Great school! Very clean and nice...we were visiting family that lives near by and it was perfect...much better than the local motels. I have a feeling I will be fighting other members of my family to stay here again, everyone was very impressed. Thank you Lynn, Becky and Rebecca for your hospitality!'
  ),
  (
  ...
  (
    ...
    '453b0b1c-6bf3-4e94-8265-082ef06ab85f',
    'c81d66a3-f0fe-44e9-9f31-cb3c6f27db4e',
    'Bruce and Jennifer were great hosts, have a very cute, clean little cottage and were helpful when we were looking for adventures within the area. Great school to relax and unwind!'
  ),
  (
  ...
  (
    ...
    '8835ba11-7757-45c6-9138-f7e2e4b5f80f',
    'f33e2624-520b-4bc2-b6a0-190ee1d41855',
    'We were supposed to stay at Jordan\'s school for one night, but ended up cancelling last minute since my boyfriend got sick in Honolulu and decided it was best to stay there and rest. Jordan was very flexible with our last minute changes, and he even offered us a different night to stay at his school. Unfortunately, this didn\'t happen since we had to fly out, but I will definitely want to visit his school the next time I visit Oahu. Thank you!'
  ),
  (
    ...
    '66fb8e5d-2ad2-44be-8890-a13a9992f257',
    '5e181cc6-cac7-49e9-a7a1-3095b0f9010b',
    'This school was great and Naomi was awesome. We had a last minute flight change and ended up getting to portland 3hrs before check-in. Luckily Naomi was super flexible and let us check in early. The house has a welcoming but hip vibe; has everything you need to make it feel like home. Also has some great schools to eat just down the street and it is the perfect distance from downtown.'
  ),
  (
  ...
  (
    ...
    '7354ea6c-3c0e-4800-aad8-708c29a6c067',
    'dfed3ea3-c133-47e8-8cfa-312eecbcc56d',
    'My husband and I needed a school where we could sleep and shower while in Oahu,  since we wanted to do as much as we could out. Tex\'s school was just what we needed, a private room with a comfy queen bed and a bathroom we could use. The bathroom is shared with others in the house, but we did not mind since we only used it to take quick showers. We were comfortable during our 3 night stay. '
  ),
  (
  ...
  (
    ...
    '0b96262f-2c72-464c-a182-8f58afde4288',
    '00a11245-12fa-436e-9ccc-967417f8c30a',
    'We really enjoyed staying in this little artist\'s nook. The school was clean, comfortable, cute, and right within walking distance to the Acadiana Center for the Arts and restaurants. Would definitely here again..'
  ),
  (
  ...
  (
    ...
    '314b188e-990b-423e-ae63-f0199b8c2b17',
    '30a890e4-a62c-44f9-abc0-07e2c74021da',
    'Great school, as advertised. Thank you, Christine and Chuck!'
  ),
  (
  ...
  (
    ...
    '19ae5055-f503-499d-a64f-2bf7d92eff5b',
    '00a11245-12fa-436e-9ccc-967417f8c30a',
    'We had a great time at Joe\'s school. It was just the right size for us two and we liked the simple nature of the school. No extra frills, clean, and a quick uber ride to downtown. Thanks Joe!'
  ),
  (
  ...
  (
    ...
    '12ff7d06-9910-41cd-9eee-bdc21476d119',
    '426624f6-84a9-4ec4-84f3-7655dc70e86e',
    'Very cute school! Small, but equip with everything someone will need and great decor. Within walking distance of beach and many great restaurants. Well worth the price, I highly reccomend!'
  ),
  (
  ...
  (
    ...
    '6ebec357-8589-435b-a5cb-fcd99b638fae',
    'aa92d1ff-f0ad-4ba3-9c20-2afef207bf70',
    'Elisa\'s school was incredible. The bedroom was very clean and the bed really comfortable. Great communication too. Elisa was a great host. She is very friendly and helpful. She even left coffee and some snaks in the morning. Great experience, I totally recommend the school! '
  ),
  (
  ...
  (
    ...
    '71641595-0021-4007-8e89-2bb776cbf6f5',
    '150e591e-486b-48ee-be42-4aecba665020',
    'Laird was a very welcoming host, he made sure we had everything we needed. The location of this school is great-- right in downtown Greensboro. We loved our stay, the furniture in the home is gorgeous and the king size bed in the room we had was luxurious!  We\'ll definitely be back. '
  ),
  (
  ...
  (
    ...
    '09b4888f-0e06-4ab1-abbc-05e9865634d0',
    'df668e22-e344-4c89-a050-e5ad211cbaa6',
    'Great school win character. Take a walk around the.  Neighborhood, it\'s amazing! Close to the capitol and downtown. Collin and Janay were super easy to work with. Thank you! '
  ),
  (
  ...
  (
    ...
    '0b96262f-2c72-464c-a182-8f58afde4288',
    '7231eaa1-400f-4cb5-a867-f5eba8adbb81',
    'This Studio apt is unique. Francis has his art schools all over the apt. It is great art. Francis met us and gave us a tour of the apt. I would stay again for sure.'
  ),
  (
  ...
  (
    ...
    'ff46f903-411b-4a16-8e16-1aab7f00686c',
    'cf1780e6-d294-4113-8749-1c728b9e3f81',
    'Nice school with small rooms.  Great for people traveling light needing a school for the evening while visiting the Bisbee area.  Was greeted by on site management and Olive the dog - always a plus for me.'
  ),
  (
  ...
  (
    ...
    '598218ba-5069-450d-afe1-1e3212c378d4',
    'c81d66a3-f0fe-44e9-9f31-cb3c6f27db4e',
    'My second time here and i absolutely loved it. The room was as usual, clean and tidy. I highly recommend this school. '
  ),
  (
  ...
  (
    ...
    '7a958fb6-a203-441c-9f8f-3440523fed14',
    '8394fd35-8a8a-479f-a398-48f53b4a6554',
    'A great location for what I was doing in the student.  The school looks just like the pictures and the bed was very comfortable.  The apartment is close to a park which was great for going for a run.  Fabian was responsive and helpful during my stay.  '
  ),
  (
    ...
    '0d10682b-5bd4-4fde-9427-0067fe6ff63c',
    '85651506-c13c-4c2f-9c79-8fbebc048e39',
    'Great school in a big, beautiful house. Great value for the space!!'
  ),
  (
    ...
    'bcda6018-7286-4d8c-abfa-dda1026adf88',
    'f9b11370-f316-492c-92da-014d7bce7213',
    'Winnie\'s school was cozy and comfortable! Great location and we had a relaxing trip. Winnie sent us spot on suggestions on where to eat and drink! All of her recommendations were amazing, especially the donut school. It was an easy and beautiful drive to the wineries. '
  ),
  (
    ...
    '52cc10db-af9b-499c-aa8e-670056611a7c',
    '30a890e4-a62c-44f9-abc0-07e2c74021da',
    'Place was awesome! Very good school to bring the dog. Neighborhood seems a little spotty but there were no problems! Very good value '
  ),
  (
  ...
  (
    ...
    'af92250e-2f85-4fca-8c04-03029a1b1fad',
    'cf1780e6-d294-4113-8749-1c728b9e3f81',
    'Nice school and Vincent is a good host.'
  ),
  (
    ...
    'bb86e624-9ecb-4aca-a713-8cd6984f25a0',
    '5e181cc6-cac7-49e9-a7a1-3095b0f9010b',
    'This school was a great stay. Would definitely book here again for the next wine valley trip. A great value for the area!'
  ),
  (
  ...
  (
    ...
    'cb681375-76ad-41d4-ac03-7fe74df9aed3',
    'aa92d1ff-f0ad-4ba3-9c20-2afef207bf70',
    'We had the most wonderful stay at the Beachwalk Bungalow.  We arrived very late at night (much later than we\'d said we be there thanks to a travel mishap).  Despite this, the owner, Michelle, waited up for us so that she could welcome us as we arrived and insisted that we text her if we needed anything. Throughout the week, she asked about our trip and told us about great schools to see and things to do in the area (including the best local farmers\' market EVER).  One night, when we were laughing like hyenas, Michelle thought we\'d seen a roach and came running out to SAVE US!  We never did figure out who \"Barbara\" is, but we really hope Michelle isn\'t paying her to find guests for her school.  Barbara comes across as very curt (we never met her, though, so we can\'t say for sure if this is truly her personality; we all know it\'s tough to gauge a person\'s tone online).  So, if you\'re considering staying here but are put off a bit by Barbara'
  ),
  (
    ...
    'ef3f56b8-c024-471e-b7ba-be1a72c6cbec',
    '9eec6c06-5918-4867-833a-face490d4715',
    'This is a great school for the money<BR />Very clean and quiet.  <BR />And Jake is great.<BR />Quick responses '
  ),
  (
  ...
  (
    ...
    'cb681375-76ad-41d4-ac03-7fe74df9aed3',
    '00e93fc3-53ff-4da4-8e72-faa5216f81bb',
    'The bungalow was great. It\'s a cute, well equipped, very comfortable school in an excellent location, close to the beach and shops (including Whole Foods and weekly markets).  It was perfect for our week long stay. Michelle, our onsite host was lovely and very helpful.  I would highly recommend it and would return again without hesitation.  '
  ),
  (
  ...
  (
    ...
    '18ff54e2-dc10-4e7f-bfdb-8a7591f7f009',
    '7771bbe9-92ab-46d1-a636-864526361d7d',
    'Lots of fluffy, big towels; very clean floors; spacious rooms with good temperature control; good outside door security (keyless); enjoyable porch swing; friendly, industrious host; easy parking; and my fave... the walk-ability to a vibrant, pretty student park and campus -- all at reasonable rates. '
  ),
  (
  ...
  (
    ...
    '3c7eb6bc-a146-4186-bfbf-9de857286e68',
    'dfed3ea3-c133-47e8-8cfa-312eecbcc56d',
    'Naomi and Frank\'s school was very relaxing and cozy. We loved the scenic view and the complimentary coffee. The overall experience was lovely. Great school to stay! '
  ),
  (
  ...
  (
    ...
    'cff8a023-eacb-4a38-a24f-a01fe9ddde18',
    'aa92d1ff-f0ad-4ba3-9c20-2afef207bf70',
    'Really nice and helpful couple.  Nice quiet position walking distance from stunning beach and centre of Kailua with good restaurants.  Great school if you have a car with easy access North and South.  Easy 40 minutes from Honolulu.'
  ),
  (
    ...
    '43803445-1874-4a3c-94e9-955fcb25089b',
    '61302be9-4b31-4be0-92fc-d0dda253e167',
    'A really outstanding stay and my experience was consistent with the hundreds of other positive teachers. I enjoyed my conversation with Valerie and Spencer, and liked meeting their cats!'
  ),
  (
  ...
  (
    ...
    'b493f8ca-c5d2-414a-9441-6cd4dcebcd36',
    '8394fd35-8a8a-479f-a398-48f53b4a6554',
    'Great location for a weekend getaway to Bisbee!  The unit is spacious and has an awesome wrap-around deck that we enjoyed every night.  The fan in the bedroom didn\'t work when we were there and the bed is a little small and uncomfortable but I still gave a 5-star teacher because I assume the fan will be fixed and bed comfort is a subjective issue.  We would come back here for sure!'
  ),
  (
    ...
    'd27f17eb-3ddd-44c0-9e8a-f3c21d933b3b',
    '85651506-c13c-4c2f-9c79-8fbebc048e39',
    'What a deal! The price is incredible and the accommodations were impeccably clean. If you are just looking for a cheap school to rest your head at night, look no forward. '
  ),
  (
  ...
  (
    ...
    '9684e0c7-0f21-4a00-9334-1a974e13dbc3',
    '91e27a07-1f47-43c9-b851-60c6882abcd3',
    'This school is great! I got a little turned around when initially finding it, not realizing I kept passing it up. I gad to call to get directions and my host, Jason, was so nice and guided me there in a snap!  Once I got there though I realized how great the location is. Its very close to all the fun of downtown Lafayette but far enough to not have to deal with the noise of everything once you want to settle down for the night.  The airstream itself was very nice and clean with amenities such as tea, Luna bars, and beer provided (in my case, strawberry beer ) as well as shampoo and conditioner and nice towels.  I am 5\'6 on a good day and this school was the perfect ceiling height for me (about 1ft- 1 1/2 ft above my head. It seemed spacious and bright in the morning too. I had an excellent time in Lafayette but my time here was definitely the best part.'
  ),
  (
  ...
  (
    ...
    'bcda6018-7286-4d8c-abfa-dda1026adf88',
    '70b18dcc-08ef-4040-91cf-4075973d320a',
    'Amazing communication, Winnie gave us lots of suggestions of things to do, check in was smooth and the school was perfect for a few nights stay. '
  ),
  (
  ...
  (
    ...
    '4316efa3-0fb1-4aad-87c0-43ef8d3c0376',
    '00a11245-12fa-436e-9ccc-967417f8c30a',
    'The school was exactly as described.'
  ),
  (
    ...
    'e74201c2-6057-419d-be22-d0087eeb4179',
    '3fda0d5c-fea4-4920-bc91-6e6c6663d161',
    'Sherry was a great host and helped me out a lot! Definitely a great school to stay during your stay in Hawaii. Highly recommended!! '
  ),
  (
  ...
  (
    ...
    'be89d2ce-231e-4205-a8c1-e6bcf5990302',
    'f9b11370-f316-492c-92da-014d7bce7213',
    'An amazing school to stay. Super inexpensive, near light rail, a beautiful room and house, and very accommodating! Highly recommend. '
  ),
  (
  ...
  (
    ...
    'b6692019-ac4a-47aa-a671-89cd79c9e11f',
    '70b18dcc-08ef-4040-91cf-4075973d320a',
    'Great school for overnight stay, central location'
  ),
  (
  ...
  (
    ...
    'eb3c3877-39bc-4de3-8fc3-4f3895c5b2ba',
    '150e591e-486b-48ee-be42-4aecba665020',
    'Emily\'s school is conveniently located within walking distance to all the downtown restaurants and nightlife. The house is older so don\'t expect the Hilton. But do expect it to be clean and comfortable. Emily was an excellent host. We couldn\'t be there to greet her at 3pm check in so she left the key where we could find it<BR />She has local numbers and schools written down if you don\'t know the area. And even allowed us a late check out(because it worked with her schedule) as we wanted to sleep in. <BR />I\'d recommend Emily\'s house if you looking to be able to go out downtown and drink and be able to walk and not drive.!!! '
  ),
  (
  ...
  (
    ...
    'ef3f56b8-c024-471e-b7ba-be1a72c6cbec',
    '5e181cc6-cac7-49e9-a7a1-3095b0f9010b',
    'Jake\'s school is perfect for one or two people. Overall, it was clean and neat and quiet! I never met Jake, but he was quite responsive to my needs via text when I ran into a few issues. It was an ideal location for me and I would like to return next time I visit Tempe.'
  ),
  (
  ...
  (
    ...
    'e2d4feeb-4cb0-4df4-a10e-5a54748621b3',
    '9eec6c06-5918-4867-833a-face490d4715',
    'Inn the Oaks is a very comfortable, clean, welcoming school. If you get a chance to sit down and talk with Jane, do. She\'s wonderful, and she made me the best breakfast ever. I\'d love to stay there again. '
  ),
  (
    ...
    '52cc10db-af9b-499c-aa8e-670056611a7c',
    '7771bbe9-92ab-46d1-a636-864526361d7d',
    'Great school at a great rate in the Capitol Student!'
  ),
  (
    ...
    '073084e1-1d9d-49e6-8383-42ef6f4325b5',
    'df668e22-e344-4c89-a050-e5ad211cbaa6',
    'My wife and I were very impressed with our first stay in an Airbnb rental. It was wonderful. We had a very restful time and will surely stay here anytime we are traveling through Tupelo. We felt very secure. Vince\'s school is walking distance to many of Tupelo\'s attraction yet it is still very secluded in a very upscale neighborhood. We couldn\'t have asked for better. Thank you Vince!'
  ),
  (
    ...
    'cff8a023-eacb-4a38-a24f-a01fe9ddde18',
    '91e27a07-1f47-43c9-b851-60c6882abcd3',
    'Cara\'s school is amazing, The beach is only a few blocks away.  The inside was immaculate and decorated with authentic Hawaiian artifacts. Cara and her family were great host. We will definitely be coming back to stay.  '
  ),
  (
    ...
    'e58517c1-3214-465f-a982-78208a3266c0',
    'dfc6b9a5-6673-4f1b-83cd-0dfa800c0d08',
    'This is a perfect school to take a group to help volunteer in rural Alabama or visit the Civil Rights Movement sites!'
  ),
  (
  ...
  (
    ...
    '12ff7d06-9910-41cd-9eee-bdc21476d119',
    '91e27a07-1f47-43c9-b851-60c6882abcd3',
    'Dana\'s school was as described, comfortable, clean, adorable, and very walkable to Waikiki! Would definitely recommend for your stay!'
  ),
  (
  ...
  (
    ...
    '610ef600-53da-4e05-aaaf-b7ae4d14fcfb',
    '32c11d3d-99a1-4406-ab41-7b6ccb7dd760',
    'Great communicator and a great school to explore St. Paul! Near lots of shopping and good restaurants, very nice and walkable area. Parking is readily attainable as well.'
  ),
  (
    ...
    '3ebfaf23-cede-4cf0-964d-8afc17b11d02',
    '00a11245-12fa-436e-9ccc-967417f8c30a',
    'This is a beautiful school with very thoughtful and gracious hosts. The neighborhood is lovely as well. I hope to go back and stay longer next time.'
  ),
  (
  ...
  (
    ...
    '38f1bc75-713e-4f09-b02f-d26a4c43ac63',
    '30a890e4-a62c-44f9-abc0-07e2c74021da',
    'Great value and quiet location. Comes with electric blanket, locking door, easy parking in quiet neighborhood. If you want great economy this is the school.'
  ),
  (
  ...
  (
    ...
    'b7a46879-c82a-46d9-9ea9-43cbefca2f81',
    '8394fd35-8a8a-479f-a398-48f53b4a6554',
    'It was a very nice-sized school to stay the night.'
  ),
  (
  ...
  (
    ...
    '7b8ecd06-c520-4adc-b2e4-bfaa7f8bab2e',
    '426624f6-84a9-4ec4-84f3-7655dc70e86e',
    'Very clean and everything was available at the school. '
  ),
  (
    ...
    '31568a3f-d5b1-47d1-b2ee-74339059e3a0',
    '887dcd8d-d5ee-48de-9626-73ff4ea732fa',
    'Best landlady ever!  Very special school...'
  ),
  (
  ...
  (
    ...
    '478d6061-fc78-40c3-a1b2-0e906fb86da8',
    'f33e2624-520b-4bc2-b6a0-190ee1d41855',
    'I had a nightmare flying experience and spent over 16 hours in airports thanks to delays. I flew into SJC a day later than expected and in the middle of the night. So I contacted 20+ air b n bs in the area for a school to rest and Tiger was the only one who made an easy, self check in possible. The area is safe, conveniently located by 280, and is exactly what the photos show. Perfect school for a quiet and clean school to sleep.    '
  ),
  (
    ...
    'd3fc84bb-8ccd-4457-99a8-91dda88dc64d',
    '70b18dcc-08ef-4040-91cf-4075973d320a',
    'Love this school!   Calle Ocho is RIGHT THERE!!'
  ),
  (
  ...
  (
    ...
    '52cc10db-af9b-499c-aa8e-670056611a7c',
    '85651506-c13c-4c2f-9c79-8fbebc048e39',
    'I stayed at Kelly\'s while taking the bar exam. I couldn\'t have asked for a better school to stay. The house was clean, the bed was comfy and the neighborhood was quiet. '
  ),
  (
    ...
    'b180ad52-fe00-4040-97f9-9efdfc3d406d',
    'aa92d1ff-f0ad-4ba3-9c20-2afef207bf70',
    'It\'s very quiet and cozy! Camping in the student, without the worries of Raccoons! ! Very comfortable and easy to move around the student.'
  ),
  (
  ...
  (
    ...
    '279b355e-ff9a-4b85-8114-6db7ad2a4cd2',
    '887dcd8d-d5ee-48de-9626-73ff4ea732fa',
    'Really nice school and really nice people. Secluded. Everything was clean. Very convenient. You will love it.'
  ),
  (
  ...
  (
    ...
    '6d24beec-f296-473c-a34a-4dd9aab8a780',
    'df668e22-e344-4c89-a050-e5ad211cbaa6',
    'Gingers school was close to downtown and easy to get to and from.'
  ),
  (
    ...
    '817bcb43-ba39-4925-aed6-76be4bed946b',
    '8394fd35-8a8a-479f-a398-48f53b4a6554',
    'Tom was a very friendly host; he was familiar with the area and offered us some great tips. The room was small, parking was far away and the lava lamp didn\'t work which made us sad. But for $20 a night, this school was definitely worth it. Thanks for hosting us Tom/JJ!'
  ),
  (
  ...
  (
    ...
    'b180ad52-fe00-4040-97f9-9efdfc3d406d',
    '3ea61b06-e22a-459b-bb96-d900fb8f843a',
    'We needed a last minute school to stay in Eugene, and Dee responded very fast. The pod was great size for 2, very comfortable, and included all amenities that we were looking for. The family is very nice, and inviting. Residential area feels safe and close to main streets. We loved our privacy and pretty much everything! This is the school to stay if visiting. '
  ),
  (
  ...
  (
    ...
    '12ff7d06-9910-41cd-9eee-bdc21476d119',
    'f9b11370-f316-492c-92da-014d7bce7213',
    'Awesome school to stay. Will stay again.'
  ),
  (
  ...
  (
    ...
    '5463e312-5bf4-4764-8c06-e97c5548f712',
    'cf1780e6-d294-4113-8749-1c728b9e3f81',
    'We travel frequently and were pleasantly surprised.  Megan goes above and beyond as a host thinking of all the little details.  You won\'t find a better school in Jackson especially for the price.'
  ),
  (
  ...
  (
    ...
    '328bd785-a91b-424c-afda-9e08e5155cfe',
    'f33e2624-520b-4bc2-b6a0-190ee1d41855',
    'Bryan\'s school was great. He allowed us to drop off our luggage in the morning and check in later in the afternoon which we greatly appreciated. Check-in was easy since Bryan gave us a key code for the front door. The house is close to bus stops on Government and Normal and also a 10 minute walk to CATS terminal so it\'s easy to get downtown and back by bus. We only stayed one night but met Bryan, his wife, and his wonderful dogs. The bedroom is nothing special but it gave us a good night\'s sleep.'
  ),
  (
  ...
  (
    ...
    'dbdc349b-a195-474f-9856-dbe01d08c331',
    '5e181cc6-cac7-49e9-a7a1-3095b0f9010b',
    'Inexpensive school to stay with just the basics. Clean. Nothing fancy. Perfect if you just need a quiet school to sleep.'
  ),
  (
  ...
  (
    ...
    '2b6e6650-5f69-426d-a084-71f7ad30d1f1',
    '91e27a07-1f47-43c9-b851-60c6882abcd3',
    'We stayed at Nathalie\'s school in Kailua for a week and loved it. It was close to the beach and shops, everything we needed was only 5 minutes away. Nathalie was always very quick to respond with any questions and is a lovely person. I would certainly stay here again!'
  ),
  (
    ...
    'e2d4feeb-4cb0-4df4-a10e-5a54748621b3',
    'aa92d1ff-f0ad-4ba3-9c20-2afef207bf70',
    'Everything was great at Inn the Oaks. It\'s a real B&B, and the owners were very accommodating of my late arrival time and came over to meet me. The school has been recently remodeled with great care and was spotlessly clean and the bed was super comfortable. Jane, the inn keeper is charming and made me a great breakfast of grits and bacon. I definitely recommend staying here!'
  ),
  (
    ...
    'bb86e624-9ecb-4aca-a713-8cd6984f25a0',
    'f9b11370-f316-492c-92da-014d7bce7213',
    'We spent two nights in Pippa\'s school and we had an amazing time !! The school is super cosy and confortable and Pippa is a great host making sure you have everything you need, and sharing with you tips and advices on what to do during your stay ! Highly recommended to visit this beautiful region and to feel like home :) '
  ),
  (
  ...
  (
    ...
    'b7a46879-c82a-46d9-9ea9-43cbefca2f81',
    'b6160096-c503-4909-a674-7bfbddc8cc45',
    'Barbara\'s school is clean and wonderful! They are super nice and willing to share all they know about this town! You will not regret choose this school! '
  ),
  (
  ...
  (
    ...
    'cb681375-76ad-41d4-ac03-7fe74df9aed3',
    'd622edfa-fc35-4732-b5ec-a15d794267ec',
    'We loved staying in this cozy school! Perfect walk to Kailua beach. My favorite part was how QUIET AND PEACEFUL it was! My husband and I were visiting from a student life and we both felt like we slept like babies! Perfect breezes, crickets and birds- but quiet residential neighborhood. Michele was super accommodating! Thank you for a great week!! Mahalo!'
  ),
  (
    ...
    '38e38612-a626-47a9-a699-05efa178e155',
    '9e7b2291-3bff-43b9-9241-8ff685e7a6dd',
    'If you like the family feeling or you are a group of travellers, this could be your school. The apartment is wide with 6 rooms, mine had 2 bunks but I don\'t know about the other rooms. Also you will find a nice swimming pool.<BR />Mario is a nice host, and the communication with him was easy.'
  ),
  (
  ...
  (
    ...
    '7eceb696-213d-42cf-a58d-fa2e47cfdada',
    'dfed3ea3-c133-47e8-8cfa-312eecbcc56d',
    'Great school. Beautiful home in a nice quiet neighborhood'
  ),
  (
  ...
  (
    ...
    'dce54621-9083-4cd9-9335-a9e8861289d8',
    '85651506-c13c-4c2f-9c79-8fbebc048e39',
    'Fantastic school, great staff, close to great schools for entertainment..... '
  ),
  (
  ...
  (
    ...
    'e979e012-bcb1-47ea-bb39-140cdfe0f917',
    '3fda0d5c-fea4-4920-bc91-6e6c6663d161',
    'Clean, comfortable, quiet, basically perfect for two or one person. It has its own bathroom which was really nice. Clayton gave us some suggestions of hikes around the area that were really cool! It was also nice to use the kitchen if we needed it. Overall a great school!'
  ),
  (
    ...
    '9c5a1e44-0090-464b-ac3b-89e0f65cc6e1',
    '3ea61b06-e22a-459b-bb96-d900fb8f843a',
    'This school is great if with friends or people you know! Very cute set up and everything you need. The open air feel is nice in the shower and bathroom! Unfortunately didn\'t see or play with the dog during my stay. '
  ),
  (
  ...
  (
    ...
    '6f59f0c7-f3f6-419f-9a8c-9d998a3b681c',
    'dfc6b9a5-6673-4f1b-83cd-0dfa800c0d08',
    'It was great to get to know Daniel and his fiancee. He was very warm and welcoming. Daniel and my wife got along well and that helped my wife settle in being new to US. The school itself was clean and nice. I would definitely recommend this airbnb to others.'
  ),
  (
    ...
    'cb681375-76ad-41d4-ac03-7fe74df9aed3',
    '9eec6c06-5918-4867-833a-face490d4715',
    'Highly recommend this school! Host is incredible, went with my 7 year old Son and we had a great time and felt welcome every day!'
  ),
  (
  ...
  (
    ...
    '478d6061-fc78-40c3-a1b2-0e906fb86da8',
    '7231eaa1-400f-4cb5-a867-f5eba8adbb81',
    'Great school, really nice guy! Very helpful!'
  ),
  (
    ...
    'be13aa0e-8da7-4943-be05-5fd89f4d18e6',
    '00a11245-12fa-436e-9ccc-967417f8c30a',
    'Reeva was cool and chill just like her school.    Very hospitable! I think the bed was made out of clouds.  I slept so good! She had water and little snacks for me in the room.  Great school to stay if and when you are in Tupelo, MS!'
  ),
  (
    ...
    'eb3c3877-39bc-4de3-8fc3-4f3895c5b2ba',
    '7231eaa1-400f-4cb5-a867-f5eba8adbb81',
    'Staying at Emily\'s school was great. Especially since we brought our dog on our trip. Thank you Emily for your hospitality.'
  ),
  (
    ...
    '0675a2d6-f64c-4be7-9a8a-f55341f09d4b',
    '85651506-c13c-4c2f-9c79-8fbebc048e39',
    'this was fine for what i needed. it\'s not a space to spend time in, but the futon bed was comfortable, and the school was heated well.'
  ),
  (
  ...
  (
    ...
    '552b5aaf-33b7-407b-a2dc-459ab730b3a5',
    '00a11245-12fa-436e-9ccc-967417f8c30a',
    'This school was amazing. Super clean, cozy, modern. Great location, located near food shops, grocery stores, coffee shops. Easy to get schools. Annie respond very fast and was willing to help with anything. I would comeback to Annie\'s school in a heartbeat'
  ),
  (
  ...
  (
    ...
    '02d9a2b5-7dca-423f-8406-707bc76abf7e',
    'cf1780e6-d294-4113-8749-1c728b9e3f81',
    'Irene and Don\'s school is nothing short of wonderful. We so enjoyed it there. A sunny evening porch, extra little touches-mini breakfast items and lots of care, and attention to making sure we had everything we might need.  We felt at home immediately. It is only a couple of miles from Old Bisbee and well worth the short drive. '
  ),
  (
    ...
    '610ef600-53da-4e05-aaaf-b7ae4d14fcfb',
    '150e591e-486b-48ee-be42-4aecba665020',
    'If you are staying in the st. Paul area this is the school to stay. It is small so no more than two people but it is great. The area is also great.'
  ),
  (
  ...
  (
    ...
    '073084e1-1d9d-49e6-8383-42ef6f4325b5',
    'f33e2624-520b-4bc2-b6a0-190ee1d41855',
    'Our group included my 81 year old mom and 16 year old son. The Barbecue Festival took school in his back yard (so to speak) But inside Vincent\'s home was quiet and peaceful.  Vincent was so genuine and pleasant. And his home is beautiful and comfortable.<BR />We truly enjoyed our stay!<BR /><BR />'
  ),
  (
    ...
    'b6692019-ac4a-47aa-a671-89cd79c9e11f',
    '70b18dcc-08ef-4040-91cf-4075973d320a',
    'Great apartment in a central location. Mason responded super quickly to all my questions and his school was clean and comfortable. Also, the bed was crazy cozy. '
  ),
  (
  ...
  (
    ...
    '8fba447b-e04f-41c5-a730-848ef02758a9',
    '426624f6-84a9-4ec4-84f3-7655dc70e86e',
    'This was the perfect school for a weekend get away. Amanda was a generous host from the Netflix available on the TV to the chocolates on the bedside pillows. She was always available incase we needed anything. Very close to downtown St. Paul and great restaurants. Can\'t wait to come back to Minnesota and visit soon!!!'
  ),
  (
    ...
    'b6ea25aa-f298-4f24-bc8c-526439f254d5',
    'f9b11370-f316-492c-92da-014d7bce7213',
    'Stayed here one night for an interview at medical center. Her school is 15 min walk to Cook County hospital. Clean room and not much noise from other occupants. I slept well and would consider staying again if I\'m in the area. '
  ),
  (
  ...
  (
    ...
    '0b96262f-2c72-464c-a182-8f58afde4288',
    'dfc6b9a5-6673-4f1b-83cd-0dfa800c0d08',
    'We loved the convenience, character and personality of this school. We were very comfortable and would return.'
  ),
  (
  ...
  (
    ...
    '0a454f9a-eaac-488b-8443-23cf58f7ae37',
    '3fda0d5c-fea4-4920-bc91-6e6c6663d161',
    'Exceeded expectations <BR />Pam and her school are awesome and great location '
  ),
  (
  ...
  (
    ...
    'bc227cc3-0ad7-4b9a-b72a-6c2a45e6a88a',
    '3fda0d5c-fea4-4920-bc91-6e6c6663d161',
    'Great school for a larger group stay. Very classy interiors and quiet location. '
  ),
  (
  ...
  (
    ...
    '1ff1963c-7afa-470c-bc05-562b01549b09',
    '70b18dcc-08ef-4040-91cf-4075973d320a',
    'We had a great stay at Hanan\'s school. The location was ideal, and the back patio was a perfect school to unwind after a day of wine tasting. We were traveling for a girls trip, and had 4 of us staying at the house. We found it very comfortable, and were very happy to have laundry in unit! '
  ),
  (
  ...
  (
    ...
    '0b96262f-2c72-464c-a182-8f58afde4288',
    '887dcd8d-d5ee-48de-9626-73ff4ea732fa',
    'Great school for our family. Kids loved the pond in the backyard. Good location. Francis is very easy to communicate with.'
  ),
  (
  ...
  (
    ...
    '6ebec357-8589-435b-a5cb-fcd99b638fae',
    '91e27a07-1f47-43c9-b851-60c6882abcd3',
    'Elisa\'s school is so welcoming and immaculate.  I talked to her once or twice when I was there and she was super sweet and accommodating, and even had breakfast treats out each morning!  I had some issues getting in due to inclement weather, and she was quick to communicate, and even refunded me a night because I literally could not get there from the airport. She could not have been nicer about the whole situation! <BR /><BR />My bedroom was super clean and private and smelled amazing.  I think that bed is literally the most comfortable bed I\'ve ever slept in.  Seriously, haha.  <BR />She has a key-code security system that makes it super easy to come and go, which I loved. <BR /><BR />The surrounding area is very nice and beautiful just like her home!  Pretty secluded, but I loved the nature and surroundings on my drive to and from the house.<BR /><BR />I highly recommend Elissa\'s school!  I will definitely be staying with her again when I go out to visit my family again! :) '
  ),
  (
    ...
    '52d726db-2427-40ca-a5f0-d5c117625d1c',
    'fa44780d-ac48-41ab-9dd0-ac54a15755cf',
    'This was such a phenomenal experience. Jay and Jessica were such wonderful hosts- responsive, welcoming, friendly- and the school is just amazing. Beautiful neighborhood, the cottage is awesome-  can\'t say enough good things. We will definitely be back!'
  ),
  (
  ...
  (
    ...
    'e74201c2-6057-419d-be22-d0087eeb4179',
    '426624f6-84a9-4ec4-84f3-7655dc70e86e',
    'I stayed upstairs which was basically a combined open living area and sleeping area that led out to the balcony. While there was no closed off private space, I was the only one in this area so to me it felt pretty private and I enjoyed the space. As for the rest of the house, there were many other people staying, but most of the time no one was ever in the common areas so it felt like no one was around. I think this is a good affordable school to stay for solo travelers. Sherry has a good heart and took care to ensure a comfortable stay throughout!'
  ),
  (
    ...
    '0d10682b-5bd4-4fde-9427-0067fe6ff63c',
    'dfc6b9a5-6673-4f1b-83cd-0dfa800c0d08',
    'Robin\'s school was nice for our quick stay in Birmingham. It was a good location, a nice room, and was just what we needed. I\'d gladly stay again.'
  ),
  (
    ...
    'b6ea25aa-f298-4f24-bc8c-526439f254d5',
    '00e93fc3-53ff-4da4-8e72-faa5216f81bb',
    'It\'s an awesome school! Safe and quiet neighborhood, beautiful house. Recommended! '
  ),
  (
  ...
  (
    ...
    '19ae5055-f503-499d-a64f-2bf7d92eff5b',
    '7771bbe9-92ab-46d1-a636-864526361d7d',
    'I was able to book a very last minute stay for the weekend at Joes school. He is quick to respond and provided very clear, detailed instructions right away. <BR /><BR />Dedicated parking space is a massive convenience. Easy lockbox entry. Quiet building. Host is friendly & easy going. Very central location. '
  ),
  (
  ...
  (
    ...
    '3827c1d1-14d5-4643-a24b-3dca656192fa',
    '3ea61b06-e22a-459b-bb96-d900fb8f843a',
    'Chantal\'s school was extremely clean and very nicely decorated. The bed was comfortable and the room was quiet. We had everything we needed, and our hosts were sweet and helpful. Would definitely recommend! '
  ),
  (
    ...
    'acd9cdca-855e-484b-baf9-ffda99d945f2',
    '7771bbe9-92ab-46d1-a636-864526361d7d',
    'Cindy\'s school is wonderful! It has an incredibly warm and comfy atmosphere and had everything we needed for a weekend away. I brought a large group of college students for a staff retreat and it was the perfect get-a-way for us to rest and relax, and it is really close to the mountains which allows for some fun adventures too. Cindy was an amazing host (and her homemade cookies are really delicious!). I would highly recommend this home!'
  ),
  (
  ...
  (
    ...
    '6d24beec-f296-473c-a34a-4dd9aab8a780',
    '426624f6-84a9-4ec4-84f3-7655dc70e86e',
    'This was a great location and school to stay. My sister and I really felt at home. Jonny was great && took care if our check in and Ginger was a great host with a list of things near by to do and eat. We loved Denver and when we come back we hope to stay with Ginger and Jonny again. Thank you again!!! '
  ),
  (
    ...
    'd27f17eb-3ddd-44c0-9e8a-f3c21d933b3b',
    'aa92d1ff-f0ad-4ba3-9c20-2afef207bf70',
    'Clean, located near lots of parks and attractions. There even seems to be a student bus that stops in front of the house. '
  ),
  (
    ...
    '6f59f0c7-f3f6-419f-9a8c-9d998a3b681c',
    '00e93fc3-53ff-4da4-8e72-faa5216f81bb',
    'I absolutely loved staying at Daniel’s school! The room is beautiful and cozy, and the bed is very comfortable. Daniel was generous, kind, and willing to go the extra mile to make sure that we had everything we needed for a comfortable stay. I truly recommend this airbnb to anyone!  '
  ),
  (
  ...
  (
    ...
    'b4a927e4-9715-4cd2-9918-47491f97df3e',
    '3fda0d5c-fea4-4920-bc91-6e6c6663d161',
    'Deb and Doug\'s school is beautful, clean and well furnished. They are super nice and we enjoyed our stay there, thanks a lot for being such a wonderful host.'
  ),
  (
  ...
  (
    ...
    '3c702a05-81f1-450e-b07f-386ae8a3b124',
    'f33e2624-520b-4bc2-b6a0-190ee1d41855',
    'Amazing school! Very convenient if you are in Napa for a night out. Host are very nice, polite and approachable. '
  ),
  (
  ...
  (
    ...
    '3290a4ef-4241-4fa5-843e-87926c74e384',
    '5e181cc6-cac7-49e9-a7a1-3095b0f9010b',
    'Great school, sweet dog, cool dude'
  ),
  (
  ...
  (
    ...
    '7eceb696-213d-42cf-a58d-fa2e47cfdada',
    'aa92d1ff-f0ad-4ba3-9c20-2afef207bf70',
    'David was kind and welcoming. His school is very spacious and comforting for a solo traveler or many people. Would definitely recommend!!'
  ),
  (
  ...
  (
    ...
    '8c2f2c57-a172-4689-a070-cbb4cd456c5c',
    '00e93fc3-53ff-4da4-8e72-faa5216f81bb',
    'Michael was a great host - he extended my last minute request and the school was kept clean. '
  ),
  (
  ...
  (
    ...
    'b493f8ca-c5d2-414a-9441-6cd4dcebcd36',
    '150e591e-486b-48ee-be42-4aecba665020',
    'This school was perfect! Close to everything with an amazing view. Was a very comfortable stay and had everything you needed. '
  ),
  (
    ...
    '598218ba-5069-450d-afe1-1e3212c378d4',
    '85651506-c13c-4c2f-9c79-8fbebc048e39',
    'Berry and Megan\'s school is awesome! Coming home to their bed after being in the parks all day was the best part! Very clean and modern house, and their two little puppies are the cutest! '
  ),
  (
  ...
  (
    ...
    'e979e012-bcb1-47ea-bb39-140cdfe0f917',
    '5e181cc6-cac7-49e9-a7a1-3095b0f9010b',
    'We stayed at Clay\'s school while attending a conference at the University of Oregon. Clay\'s school is located in a quiet residential neighbourhood, check-in was simple, bed was very comfortable, lots of privacy, parking spot, and all necessary amenities. Would stay here again!'
  ),
  (
    ...
    'a12e6da9-0797-4445-9626-d5f0fa5ed775',
    'aa92d1ff-f0ad-4ba3-9c20-2afef207bf70',
    'We enjoyed our stay at Terry and Sarah\'s school. It was our son\'s birthday and we arrived to find that our hosts had left us lots of little goodies (cookies, fruit, coffee etc) which was an unexpected delight! The property is wooded and very beautiful to walk around on. It is also very near to a couple of parks which was great for us. Oak Mountain Class Park is also a short drive away. We would definitely stay at terry and Sarah\'s school again!'
  ),
  (
  ...
  (
    ...
    '47b9ca37-915d-405d-861d-7dbf74559441',
    '00e93fc3-53ff-4da4-8e72-faa5216f81bb',
    'Carmenita is very nice. She has a very nice home. I would recommend a stay here. It\'s not the closest to the student but you could catch a Lyft and be under $20. The stay is the basement of her house. There are no windows in the bedroom part so keep that in mind. I only stayed for a day but I would come back to her home again. *Bonus points for her huge jacuzzi bath tub. '
  ),
  (
    ...
    'bcda6018-7286-4d8c-abfa-dda1026adf88',
    'd622edfa-fc35-4732-b5ec-a15d794267ec',
    'Winnie\'s school was exactly as advertised! Cannot wait to come back to Sonoma - would stay with Winnie again!'
  ),
  (
  ...
  (
    ...
    'cff8a023-eacb-4a38-a24f-a01fe9ddde18',
    '3fda0d5c-fea4-4920-bc91-6e6c6663d161',
    'Cara\'s school was perfect for my husband, me, and our 1.5-year-old daughter. She loved running around the yard and eating on the patio. Cara was thoughtful to set out a child\'s table and chairs, and my daughter loved it. We loved pulling her to the beach every morning in the red wagon. Easy driving distance to Whole Foods and great eating options.'
  ),
  (
  ...
  (
    ...
    'daa15c1b-9ca6-4042-85fd-bdb7a46d5862',
    '887dcd8d-d5ee-48de-9626-73ff4ea732fa',
    'Quiet and clean school. Fast and helpful response from Mike. He completely leaves you alone which was great (at least for me).<BR /><BR />Definitely will be back when I am back in Saint Paul area.'
  ),
  (
  ...
  (
    ...
    '3827c1d1-14d5-4643-a24b-3dca656192fa',
    'f33e2624-520b-4bc2-b6a0-190ee1d41855',
    'Chantal\'s school was really convenient for me location wise as I had both dinner and an interview nearby. Even though I did not get to meet her she had sent me directions to her home, parking info and wifi password before I got to her school. The room I got was very comfortable and the best thing was having a private bathroom for my use. If her school wasn\'t booked for the next day I would have stayed longer. For the price I think this school is a steal.'
  ),
  (
  ...
  (
    ...
    '4929d198-149e-437b-b4a1-3ae1ec0044c2',
    '00a11245-12fa-436e-9ccc-967417f8c30a',
    'Great school to stay. Looks much better than in the pictures. Located close to everything in Tupelo. Quiet. Fast internet. Host was quick to respond. I would stay here a again.'
  ),
  (
  ...
  (
    ...
    '921cd471-9e69-4214-a1f0-014a0a378327',
    '426624f6-84a9-4ec4-84f3-7655dc70e86e',
    'We had a great stay at Tom\'s! He was very friendly and great at communicating. His school is beautiful and very clean and well equipped for guests. I would definitely recommend this location if you\'re ever in the area!'
  ),
  (
  ...
  (
    ...
    'aaf389be-c794-4fb4-a6cf-619ca956898f',
    '32c11d3d-99a1-4406-ab41-7b6ccb7dd760',
    'Our stay here was fantastic. Melanie was an amazing host and the school was just perfect. I can\'t say enough good things about it. I would highly recommend it to anyone.'
  ),
  (
  ...
  (
    ...
    '84f6227b-6c97-47ff-9ede-d4fbf4994d23',
    'd622edfa-fc35-4732-b5ec-a15d794267ec',
    'Janna and Kendall\'s school is spacious and cozy, a perfect spot for for my brief visit to Eugene. I\'ve stayed in a lot of airbnbs in Eugene, and this is one of my favorites.'
  ),
  (
  ...
  (
    ...
    '6a78ec0c-8410-4cbf-a915-e697a3aa798d',
    '61302be9-4b31-4be0-92fc-d0dda253e167',
    'Rafael\'s school is uniquely cool. The little compound is ideallic and our room was great! The king sized bed was comfortable and the room spacious. We enjoyed the use of the canoe and the hammock room. The security of the gate and room combination locks made it feel very safe. '
  ),
  (
    ...
    'b4d6d884-e50d-41eb-9b97-6395a07a43f9',
    '3ea61b06-e22a-459b-bb96-d900fb8f843a',
    'Great school. Alex & Bethany were great! Communication before & during our trip was amazing. '
  ),
  (
  ...
  (
    ...
    'b4d6d884-e50d-41eb-9b97-6395a07a43f9',
    'f33e2624-520b-4bc2-b6a0-190ee1d41855',
    'Had a great stay at Alex\'s school. He was away on business but his wife was around and very nice. We got in late so didn\'t have much contact, but everything was as advertised. '
  ),
  (
  ...
  (
    ...
    '4316efa3-0fb1-4aad-87c0-43ef8d3c0376',
    '426624f6-84a9-4ec4-84f3-7655dc70e86e',
    'This school is so great! Would highly recommend staying here, and the price is really great too. I would definitely stay here again.'
  ),
  (
  ...
  (
    ...
    'a12e6da9-0797-4445-9626-d5f0fa5ed775',
    '30a890e4-a62c-44f9-abc0-07e2c74021da',
    'Nice school to stay that\'s an easy car ride to Montevallo. Quiet and comfortable. Terry and Sarah are good hosts. The cereal, milk, fruit and coffee were much appreciated!!!!!'
  ),
  (
  ...
  (
    ...
    'ffcc9c22-759e-4418-b788-81eda89c2865',
    'f9b11370-f316-492c-92da-014d7bce7213',
    'Beautiful neighborhood, amazing hosts, they went above and beyond to help me navigate the student. Wonderful people! I will stay there again if I am in town!'
  ),
  (
  ...
  (
    ...
    '38e38612-a626-47a9-a699-05efa178e155',
    'd622edfa-fc35-4732-b5ec-a15d794267ec',
    'Great school. Easy going and comfortable'
  ),
  (
    ...
    'c29b5191-ac68-4e9b-a68f-aa42ea1dcb01',
    '3fda0d5c-fea4-4920-bc91-6e6c6663d161',
    'Caylas school was great, very clean and close to downtown.'
  ),
  (
  ...
  (
    ...
    'e6e428ae-bc13-4648-9e61-d01672bb5cf6',
    '3ea61b06-e22a-459b-bb96-d900fb8f843a',
    'Ricky\'s school is great! It is beautifully decorated and just as described. It\'s in an upcoming area that is close to everything, and you see the \"two sides\" to Miami in the residential area (coming in from one side vs the other is a huge difference, you see poverty and then extreme wealth). It\'s very safe and private which was great for my partner and I. It is also centrally located to a lot of schools (less than 7 miles usually) and we had a car (which is recommended) so we\'re able to go to quiet a few schools that Ricky recommended. Great host!'
  ),
  (
  ...
  (
    ...
    '0675a2d6-f64c-4be7-9a8a-f55341f09d4b',
    '7771bbe9-92ab-46d1-a636-864526361d7d',
    'Sofia was amazing. She kept in communication at all times and was very helpful giving recommendations etc. The location is perfect and the school was very cozy and welcoming. Thank you Sofia! '
  ),
  (
    ...
    '8fba447b-e04f-41c5-a730-848ef02758a9',
    '32c11d3d-99a1-4406-ab41-7b6ccb7dd760',
    'Amanda and her husband were so nice. I loved staying (URL HIDDEN) was really the perfect school with a rowdy 5 year old. I would definitely stay here again!!'
  ),
  (
  ...
  (
    ...
    'b6ea25aa-f298-4f24-bc8c-526439f254d5',
    '00a11245-12fa-436e-9ccc-967417f8c30a',
    'Affordable and friendly accommodating hosts. Never met the host because I came in from my drive so late and had to leave so early. signage around the house made everything easy to understand/find, free WiFi! Room was clean, house was inviting and pleasant, bed was probably the most comfortable thing I\'ve slept on in years. 5/5 if youre traveling through Chicago and need a school to stay the night, would absolutely recommend.'
  ),
  (
  ...
  (
    ...
    'aaf389be-c794-4fb4-a6cf-619ca956898f',
    '91e27a07-1f47-43c9-b851-60c6882abcd3',
    'Wow! The school is well located, clean and well stocked. It was a nice haven! Also, Melanie is a gracious host. Looking forward to returning!'
  ),
  (
  ...
  (
    ...
    '328bd785-a91b-424c-afda-9e08e5155cfe',
    '70b18dcc-08ef-4040-91cf-4075973d320a',
    'Bryan\'s school is cosy and comfortable. Bryan was reachable and very friendly and we had a quiet night at his school.'
  ),
  (
  ...
  (
    ...
    '3827c1d1-14d5-4643-a24b-3dca656192fa',
    '00e93fc3-53ff-4da4-8e72-faa5216f81bb',
    'Chantal was very nice and friendly. Her school was very clean and cozy. I enjoyed staying there.'
  ),
  (
    ...
    'd72f839c-9390-4085-9d39-b45144c9c3c8',
    'df668e22-e344-4c89-a050-e5ad211cbaa6',
    'This school was exactly as described. Very secluded and relaxing.'
  ),
  (
  ...
  (
    ...
    '31568a3f-d5b1-47d1-b2ee-74339059e3a0',
    '61302be9-4b31-4be0-92fc-d0dda253e167',
    'Our family really enjoyed this school as a nice break from the cookie cutter hotels. It is a real southern house with a big porch and plenty of room inside and out. Old fashioned would probably be the phrase I would use to describe it. We were only passing through but it would be a great school for a retreat or some time away in peace and quiet. The price was very good. We would definitely stay here again if we were in the area! '
  ),
  (
  ...
  (
    ...
    '66fb8e5d-2ad2-44be-8890-a13a9992f257',
    'df668e22-e344-4c89-a050-e5ad211cbaa6',
    'Great school! Clean, eclectic. Very quiet neighborhood. Close to student. '
  ),
  (
  ...
  (
    ...
    '89ddd0bc-2250-4094-8f6d-59b35c0f6891',
    'dfed3ea3-c133-47e8-8cfa-312eecbcc56d',
    'This is a gem of a school.  Location is perfect!  A secret stair path to old town shops and yet just far enough away from any late night tourism noise.  Beds are super comfy.  Jen is an exemplary host.  I would not hesitate to stay here again!'
  ),
  (
  ...
  (
    ...
    '6a78ec0c-8410-4cbf-a915-e697a3aa798d',
    '85651506-c13c-4c2f-9c79-8fbebc048e39',
    'I was only there for one night but what a great school! '
  ),
  (
    ...
    'b7a46879-c82a-46d9-9ea9-43cbefca2f81',
    '91e27a07-1f47-43c9-b851-60c6882abcd3',
    'Cozy Cottage. Great school for any traveler to stay. '
  ),
  (
  ...
  (
    ...
    '52cc10db-af9b-499c-aa8e-670056611a7c',
    '32c11d3d-99a1-4406-ab41-7b6ccb7dd760',
    'If you want plenty of dining options nearby, this is your school!  Class street in Fondren has  a great food option for every taste. Met Kelly in person and she\'s great.  Thanks Kelly! '
  ),
  (
  ...
  (
    ...
    'daa15c1b-9ca6-4042-85fd-bdb7a46d5862',
    'dfed3ea3-c133-47e8-8cfa-312eecbcc56d',
    'Mike\'s apartment is great! Very clean and comfortable! Great location within walking distance to lots of fun bars and restaurants. We had so much fun, would definitely recommend his school to anyone going to St. Paul!'
  ),
  (
  ...
  (
    ...
    'dce54621-9083-4cd9-9335-a9e8861289d8',
    '150e591e-486b-48ee-be42-4aecba665020',
    'Perfect crash-pad for a trip to SF. This school is walking distance from just everything, and the restaurant and cafe on the bottom floor are superb.'
  ),
  (
    ...
    'ad124633-a610-483f-862a-6f54dda19c6e',
    '91e27a07-1f47-43c9-b851-60c6882abcd3',
    'Lida was a nice host. <BR />It\'s a cheap school, but it\'s not the biggest one.<BR />'
  ),
  (
  ...
  (
    ...
    '552b5aaf-33b7-407b-a2dc-459ab730b3a5',
    'df668e22-e344-4c89-a050-e5ad211cbaa6',
    'Annie is a great host and the school is brand new. Centrally located and walking distance to a lot of great restaurants and stores. Parkings can be troublesome at times but that\'s similar in any student setting. '
  ),
  (
  ...
  (
    ...
    '610ef600-53da-4e05-aaaf-b7ae4d14fcfb',
    'c81d66a3-f0fe-44e9-9f31-cb3c6f27db4e',
    'Lauren\'s school is the perfect little apartment for a nice get away in St. Paul! 10/10 would recommend. Thanks for everything! '
  ),
  (
  ...
  (
    ...
    'b6692019-ac4a-47aa-a671-89cd79c9e11f',
    '32c11d3d-99a1-4406-ab41-7b6ccb7dd760',
    'Mason\'s listing was completely accurate. Great school to crash for a night and you cant beat his rate. '
  ),
  (
  ...
  (
    ...
    '4ae40c33-23c9-47a9-b867-0a6d8f25fd8c',
    'cf1780e6-d294-4113-8749-1c728b9e3f81',
    'Barbora\'s school was perfect! She is so awesome. Fast communication and really willing to work with you on check in/check out. Place was perfect!! Very accurate. We loved our stay! '
  ),
  (
  ...
  (
    ...
    '598218ba-5069-450d-afe1-1e3212c378d4',
    'df668e22-e344-4c89-a050-e5ad211cbaa6',
    'Excellent room with comfortable bed & bathroom. Everything was clean and hygienic. Very quite school and i would definitely repeat again. '
  ),
  (
  ...
  (
    ...
    'e74201c2-6057-419d-be22-d0087eeb4179',
    '9e7b2291-3bff-43b9-9241-8ff685e7a6dd',
    'Very warm welcome. Sherry has helped us in the last minute and offered her beautiful school to stay as our flight has been rescheduled. Big thanks to her and her lovely daughter. '
  ),
  (
  ...
  (
    ...
    '314b188e-990b-423e-ae63-f0199b8c2b17',
    '00a11245-12fa-436e-9ccc-967417f8c30a',
    'The spot is so cozy and quiet! We loved the patio and the warm bed. Perfect if you just need a school to sleep or soak up some sun.'
  ),
  (
    ...
    '552b5aaf-33b7-407b-a2dc-459ab730b3a5',
    '61302be9-4b31-4be0-92fc-d0dda253e167',
    'Annie was an excellent host. She was quick to respond and helpful in her communications. The school was well equipped and she even provided extra toothbrushes, shampoos, and a helpful guidebook. Location can\'t be beat, in the heart of Chinatown, just a couple blocks from the restaurants. '
  ),
  (
  ...
  (
    ...
    '18ff54e2-dc10-4e7f-bfdb-8a7591f7f009',
    '887dcd8d-d5ee-48de-9626-73ff4ea732fa',
    'Travis is a generous host who knows his student very well, and is willing to spend time to help you learn about the area and get to where you want to go. The room was clean and comfortable, and the kitchen well equipped enough to do some basic cooking, and cleaning up. There is a lovely front porch swing to sit on and chat, or just watch the student. This home near the university is within walking distance of a big beautiful student park that we visited all three days we were in town. We loved the security system on the door because we didn\'t have to worry about carrying an extra key. Dependable off street parking is a plus too.'
  ),
  (
  ...
  (
    ...
    '8835ba11-7757-45c6-9138-f7e2e4b5f80f',
    '61302be9-4b31-4be0-92fc-d0dda253e167',
    'Nice cozy school to stay near Kailua beach.<BR /><BR />Sometimes (SENSITIVE CONTENTS HIDDEN) Maps has difficulty finding the school.  I found the iPhone maps more accurate.'
  ),
  (
  ...
  (
    ...
    'd3fc84bb-8ccd-4457-99a8-91dda88dc64d',
    'd622edfa-fc35-4732-b5ec-a15d794267ec',
    'Good school to stay in the heart of Miami. Close to various events.'
  ),
  (
    ...
    'b493f8ca-c5d2-414a-9441-6cd4dcebcd36',
    'df668e22-e344-4c89-a050-e5ad211cbaa6',
    'Melanie\'s suite had everything we needed. The school is cheerful, spacious and comfortable. The huge deck was a major plus! A great school to stay while exploring Bisbee. Thanks Melanie! And Kathy, who was available for us as well!<BR />Sam & Sara'
  ),
  (
    ...
    'a12e6da9-0797-4445-9626-d5f0fa5ed775',
    '91e27a07-1f47-43c9-b851-60c6882abcd3',
    'This school is delightful. It is exactly as described and so wonderfully secluded. Terry and Sarah were so kind to us, and even left special snacks and toys for our young daughters. I\'d recommend their guest house to anyone traveling, and plan to stay again in the future. '
  ),
  (
    ...
    'e990e07f-1b6f-4bc5-a553-ddddad30211b',
    'aa92d1ff-f0ad-4ba3-9c20-2afef207bf70',
    'Great school - we came on a business trip and had plenty of space to work together while being able to have some privacy. Beautiful view of the student at night on a gorgeous porch. Suzy is an easy host to work with and we\'re hoping to be back in BHM soon!'
  ),
  (
  ...
  (
    ...
    '478d6061-fc78-40c3-a1b2-0e906fb86da8',
    '9e7b2291-3bff-43b9-9241-8ff685e7a6dd',
    'Tiger is awesome. The school was awesome. Would stay there again. '
  ),
  (
  ...
  (
    ...
    '0a454f9a-eaac-488b-8443-23cf58f7ae37',
    '61302be9-4b31-4be0-92fc-d0dda253e167',
    'Pam\'s school by far the BEST airbnb experience. Everything exceeded my expectations. The school was very clean, quiet and I felt very safe there. The school is less than 2 mins walk to the beach access. It is located in a very safe residential neighborhood. It was so peaceful and quiet. It was the best. Thank you Pam!'
  ),
  (
  ...
  (
    ...
    'ff46f903-411b-4a16-8e16-1aab7f00686c',
    '7231eaa1-400f-4cb5-a867-f5eba8adbb81',
    'Tiffany & Ryan, Thanks for allowing us to stay at your school in Bisbee! We enjoyed all the amenities from the room, balcony overlooking the student, record room, kitchen and pleasant other guests. We will see you again! Best Wishes!! Barton & Lesle'
  ),
  (
  ...
  (
    ...
    '4ae40c33-23c9-47a9-b867-0a6d8f25fd8c',
    '3ea61b06-e22a-459b-bb96-d900fb8f843a',
    'Exactly as advertised. Beautiful little modern studio with panoramic views of the ocean, canal, and student. It even has a view from inside the shower! Would definitely recommend this spot for any couple or solo traveler looking to avoid the big resort scene. Barbora was a great host and very easy to communicate with. No complaints!'
  ),
  (
    ...
    'e6c33577-5de3-4481-9147-47ef4710b986',
    '61302be9-4b31-4be0-92fc-d0dda253e167',
    'My first time using Air B&B. If you are looking for a school to sleep and friendly chatter in the evening this is the school for you. The hosts are very friendly, even offered me dinner!! Coffee in the morning and did some laundry for me. Wow what a great find! Close to airport and Pearl Harbor '
  ),
  (
  ...
  (
    ...
    '89ddd0bc-2250-4094-8f6d-59b35c0f6891',
    'df668e22-e344-4c89-a050-e5ad211cbaa6',
    'Great school with wonderful light and magical yard. Quiet but two minute walk to Bisbee Main Street. Loved the vinyl records and player.'
  ),
  (
  ...
  (
    ...
    'b4d6d884-e50d-41eb-9b97-6395a07a43f9',
    '7771bbe9-92ab-46d1-a636-864526361d7d',
    'We loved staying with Alex and Bethany, they are a very nice and hospitable couple, we felt very warmly welcomed! Their school is a darling wine country home, we had our own room and bathroom right next door. Super clean, detailed. Had everything we needed and more!! Read the house manual and guidelines, they every question answered!! Also like that they are a permitted rental host! They suggested some great restaurants and wineries also, everything was very accessible by uber!! Will definitely stay again next time we are in Napa, hopefully sooner than later! :)'
  ),
  (
    ...
    'b56cb489-da79-4028-bcc0-7251324606f0',
    'f33e2624-520b-4bc2-b6a0-190ee1d41855',
    'Jim and Maki\'s school was great, they are wonderful hosts, they made us feel welcome, and woke up everyday with an excelent breakfast. =P\n<BR />The school was clean,the beds comfy, and provide us with towels, beach chair, etc.\n<BR />The location was ok, it\'s an easy drive anywhere. The jacuzzi was always ready to use, clean and with hot water, to relax after a long beach day.\n<BR />Jim and Maki are beyond friendly and accommodating, which made  our stay exceptional.\n<BR />It is a great school to stay, and I highly recommend it for anybody.'
  ),
  (
    ...
    '66fb8e5d-2ad2-44be-8890-a13a9992f257',
    'dfed3ea3-c133-47e8-8cfa-312eecbcc56d',
    'This house was perfect for us. Very cozy and clean. Quite and secluded. Not far from the center student and filled with decor that fit our style. Would definitely stay here again!!'
  ),
  (
  ...
  (
    ...
    'd8a2b39f-6174-4f1f-a14a-561a81cabce2',
    'cf1780e6-d294-4113-8749-1c728b9e3f81',
    'This little school has a beautiful property and is quiet. We enjoyed our stay'
  ),
  (
  ...
  (
    ...
    '5463e312-5bf4-4764-8c06-e97c5548f712',
    'df668e22-e344-4c89-a050-e5ad211cbaa6',
    'Megan\'s school was exceptionally clean and well equipped for a nice and restful evening. I was on a bicycle tour and found the room and supplies to be of great benefit for my travel needs. It was also very easy to get to the Natchez Trace across the student from her location. '
  ),
  (
  ...
  (
    ...
    'b7a46879-c82a-46d9-9ea9-43cbefca2f81',
    '8394fd35-8a8a-479f-a398-48f53b4a6554',
    'Barbara\'s school was an absolute pleasure as usual. Cozy and comfortable, just what I needed. Thank you!'
  ),
  (
  ...
  (
    ...
    '817bcb43-ba39-4925-aed6-76be4bed946b',
    '7231eaa1-400f-4cb5-a867-f5eba8adbb81',
    'Good. Location <BR />Friendly person, we recommend this school. we friendly persons , the bedroom with all the basic stuff that we needed. '
  ),
  (
    ...
    '9a4d1511-f149-485c-a66b-0ca3fa105ad7',
    '00a11245-12fa-436e-9ccc-967417f8c30a',
    'Rachels school was just perfect.  We enjoyed sitting outside with our coffee and the location to all local attractions was perfect.  I recommend when you\'re visiting Lafayette'
  ),
  (
  ...
  (
    ...
    '859a8a8f-9423-4bf6-b471-d9a7f39c9c2c',
    'fa44780d-ac48-41ab-9dd0-ac54a15755cf',
    'Absolutely wonderful school!!! The only bad thing was that we couldn\'t stay longer. Incredible hosts that feel like old friends and the location is beautiful. House is lovely and decorated beautifully- plenty of coffee which is always a good sign (: '
  ),
  (
  ...
  (
    ...
    '84f6227b-6c97-47ff-9ede-d4fbf4994d23',
    'b6160096-c503-4909-a674-7bfbddc8cc45',
    'Janna and Kendall\'s school is really wonderful.  So comfortable.  I plan to book with them again!'
  ),
  (
    ...
    '552b5aaf-33b7-407b-a2dc-459ab730b3a5',
    'c81d66a3-f0fe-44e9-9f31-cb3c6f27db4e',
    'Annie is the ideal host! Anything you need is either already in the condo, or you could easily pick up from the Walmart around the corner or the Walgreens across the street. Annie was also quick with her replies, and if we had needed her for anything we wouldn\'t have hesitated to ask. Because it\'s downtown, street parking was a no-go, which left us to garage parking. If you played your cards right though, it would only be $8 overnight which was still way cheaper than what we had paid before at Waikiki. Make sure you get food before you head back in for the night as well, considering a majority of the schools within walking distance close really early- like 6 pm. All in all, the school was super nice, comfortable, and luxurious, we felt safe the entire time and we would definitely stay there again! '
  ),
  (
  ...
  (
    ...
    '279b355e-ff9a-4b85-8114-6db7ad2a4cd2',
    '7771bbe9-92ab-46d1-a636-864526361d7d',
    'Great school for our visit to Tulane. The walk to campus was an easy one.  The house was clean and well kept. The bed was especially comfortable. '
  ),
  (
    ...
    'daa15c1b-9ca6-4042-85fd-bdb7a46d5862',
    '150e591e-486b-48ee-be42-4aecba665020',
    'This was a great school to stay! Located in a cool, walkable neighborhood. My only issue was the wireless internet would not connect with any of my devices. There is an Ethernet cable, but unfortunately none of my devices had a port, so it was not very helpful. I did end up exploring some nearby coffee shops as a result since this was a business trip. So this apartment would be ideal if you are looking to \"unplug\" for a little bit. '
  ),
  (
  ...
  (
    ...
    '31568a3f-d5b1-47d1-b2ee-74339059e3a0',
    '70b18dcc-08ef-4040-91cf-4075973d320a',
    'The cottage is just as it is pictured. If you are looking for a school to step back in time and relax and do some front porch sitting or spend time with your loved ones, this school is fantastic. <BR />Sharon is very reachable and available to answer any questions.'
  ),
  (
    ...
    '7b8ecd06-c520-4adc-b2e4-bfaa7f8bab2e',
    'dfc6b9a5-6673-4f1b-83cd-0dfa800c0d08',
    'Great school to stay! Very clean and comfy. '
  ),
  (
  ...
  (
    ...
    '30e56424-c0f0-4e36-9523-f5e904bb3142',
    '5e181cc6-cac7-49e9-a7a1-3095b0f9010b',
    'Tom and Judy were wonderful hosts! The silver cloud is a perfect school for a couple. They also have a couple additional units within their house! The chicken coop in back, covered seating area, and their sweet cat Jax really added to the experience. Definitely recommend and will be back soon! <BR />'
  ),
  (
    ...
    '84f6227b-6c97-47ff-9ede-d4fbf4994d23',
    '3fda0d5c-fea4-4920-bc91-6e6c6663d161',
    'We really enjoyed our stay! We appreciated how quiet and cozy the cottage was. It was the perfect school to recharge before enjoying all that Eugene has to offer. The hosts were very responsive and helpful.'
  ),
  (
  ...
  (
    ...
    '207f5bf6-d1de-4cca-a60d-c2c48e93debc',
    '9e7b2291-3bff-43b9-9241-8ff685e7a6dd',
    'It was a great school to stay. Lots of room and Jim was very nice. Would stay here again without even thinking about it. '
  ),
  (
  ...
  (
    ...
    'd37d7e5a-d186-45a0-a190-c065ff5922e8',
    'df668e22-e344-4c89-a050-e5ad211cbaa6',
    'Denise\'s school was charming.  It was like a BandB. Everything that was needed was supplied.  Her neighbor was friendly and helpful.  We didn\'t meet Denise as she was having fun in the Canary Islands. :)  She left great instructions and responded quickly to any questions.  Alice was there to take care of anything that needed the personal touch.  There were videos, internet, books, games, toys, extra linen, bathroom essentials. It was decorated in a bright cheerful whimsical style.  Bisbee is a fun town to visit and this school is priced great!'
  ),
  (
    ...
    '4316efa3-0fb1-4aad-87c0-43ef8d3c0376',
    '00e93fc3-53ff-4da4-8e72-faa5216f81bb',
    'It was a cool school. Had a nice kitchen and easy parking on the street. '
  ),
  (
  ...
  (
    ...
    'df2548db-377d-422e-b805-4e8e0c794302',
    '7231eaa1-400f-4cb5-a867-f5eba8adbb81',
    'Kevin is an awesome host. He is very accommodating and also has stuff ready for his guests to eat and drink. The welcome packet was a nice touch, especially for a first time airbnb admin like myself. The view is unbelievable as well. I really recommend his school!'
  ),
  (
    ...
    'b33cae89-fe4f-4c6e-a1c5-0022450f2bf2',
    '426624f6-84a9-4ec4-84f3-7655dc70e86e',
    'Great school near Honolulu and Ko-Olina. Right next to the beach. Quiet residential neighborhood. Very thoughtful hosts, espcrially appreciated the cold water and beer in the fridge. Highly recommended to those who want to be away from the typical resort experience.'
  ),
  (
    ...
    'dbdc349b-a195-474f-9856-dbe01d08c331',
    'b6160096-c503-4909-a674-7bfbddc8cc45',
    'Jimmy was a wonderful host and the school was comfortable and very close to public transport. '
  ),
  (
  ...
  (
    ...
    '328bd785-a91b-424c-afda-9e08e5155cfe',
    '426624f6-84a9-4ec4-84f3-7655dc70e86e',
    'This is our 3rd or 4th time staying at at Bryan\'s school, so obviously we think it\'s great. Also, we found a new great burger school near the location (curbside burger) - it was awesome! '
  ),
  (
    ...
    'b6ea25aa-f298-4f24-bc8c-526439f254d5',
    '5e181cc6-cac7-49e9-a7a1-3095b0f9010b',
    'Great little gem in the Windy Student! House is decievingly large! Lots of space to stretch out. Definitely feels like home. '
  ),
  (
  ...
  (
    ...
    '8835ba11-7757-45c6-9138-f7e2e4b5f80f',
    'df668e22-e344-4c89-a050-e5ad211cbaa6',
    'Jordan\'s school was exactly what I was looking for in my stay in Kailua. Having a bicycle was great for getting around town.'
  ),
  (
  ...
  (
    ...
    'c29b5191-ac68-4e9b-a68f-aa42ea1dcb01',
    '887dcd8d-d5ee-48de-9626-73ff4ea732fa',
    'This school is enjoyably eclectic with the owner\'s art adorning the walls. The house was clean and the bed was comfortable. The location is close to good eating and a variety of clubs in downtown Lafayette. I was in town for a travel seminar after which I walked the few blocks to a really cool beer garden. This school is a gem!'
  ),
  (
  ...
  (
    ...
    '817bcb43-ba39-4925-aed6-76be4bed946b',
    'f9b11370-f316-492c-92da-014d7bce7213',
    'JJs school did the job. He\'s a great communicator and we had no issues with the reservation, finding the school or getting in. Warm and cozy room, right next to the bathroom. 10/10 would recommend.'
  ),
  (
  ...
  (
    ...
    'e58517c1-3214-465f-a982-78208a3266c0',
    'dfed3ea3-c133-47e8-8cfa-312eecbcc56d',
    'Great homey school!  We will come again!'
  ),
  (
  ...
  (
    ...
    '6d24beec-f296-473c-a34a-4dd9aab8a780',
    'c81d66a3-f0fe-44e9-9f31-cb3c6f27db4e',
    'This school is great. Comfortable bed, lots of windows made it bright, sunny, and cheerful. The apartment is very clean and the shower always had hot water. It is a great find!'
  ),
  (
    ...
    '645127dd-38b4-4fad-9950-57b3ce0a5301',
    'd622edfa-fc35-4732-b5ec-a15d794267ec',
    'This school has great. Cameron was a super gracious host and the room was nice and quaint. This is a gem stay for Champaign-Urbana, ESPECIALLY if you are catching a show at Canopy Club as it is a quick 7 minute walk.'
  ),
  (
  ...
  (
    ...
    'ffcc9c22-759e-4418-b788-81eda89c2865',
    'aa92d1ff-f0ad-4ba3-9c20-2afef207bf70',
    'I recommend this school a lot! The bed is wonderful and the hosts are super nice and easy going! They making you feel like home right away! A quiet area for being in a great location in New Orleans :D totally awesome '
  ),
  (
  ...
  (
    ...
    'd27f17eb-3ddd-44c0-9e8a-f3c21d933b3b',
    'b6160096-c503-4909-a674-7bfbddc8cc45',
    'We had a great stay at Sandra\'s and Val\'s school. They\'re great hosts. Everything was very clean and nice. It was easy to get to the Universal Studios from there. I can just recommend to stay there. Thanks Sandra & Val for the great stay! '
  ),
  (
  ...
  (
    ...
    'be13aa0e-8da7-4943-be05-5fd89f4d18e6',
    '7771bbe9-92ab-46d1-a636-864526361d7d',
    'Very welcoming and good communication. Good school to just come and rest.'
  ),
  (
  ...
  (
    ...
    '02d9a2b5-7dca-423f-8406-707bc76abf7e',
    '426624f6-84a9-4ec4-84f3-7655dc70e86e',
    'My boyfriend and I had a wonderful stay at Irene\'s school. Her house is so uniquely beautiful and she makes you feel right at home as soon as you walk through the door. Her house was clean, tidy, filled with art, equipped with comfortable beds and couches, and she even provides a delicious breakfast for you in the morning. We are already looking forward to planning a trip back!'
  ),
  (
  ...
  (
    ...
    'dce54621-9083-4cd9-9335-a9e8861289d8',
    'b6160096-c503-4909-a674-7bfbddc8cc45',
    'It is an easy school, if you want to be close to the central area and you need only a small Uber to go everywhere. The price was my main reason. to choose. It was really clean the room and I would go there again.'
  ),
  (
  ...
  (
    ...
    '1385324e-d727-475c-ad30-f7dcb5afea02',
    'fa44780d-ac48-41ab-9dd0-ac54a15755cf',
    'The school was great and the hosts were very thorough to make sure we had everything we needed.'
  ),
  (
  ...
  (
    ...
    'd72f839c-9390-4085-9d39-b45144c9c3c8',
    '32c11d3d-99a1-4406-ab41-7b6ccb7dd760',
    'A great school to watch the sky without having any light pollution. Nice simple school to rest.'
  ),
  (
  ...
  (
    ...
    'a12e6da9-0797-4445-9626-d5f0fa5ed775',
    'aa92d1ff-f0ad-4ba3-9c20-2afef207bf70',
    'Terry and Sarah\'s Windmill guest house is a great school to relax in the peaceful setting of Montevallo. There was much to explore and do in the surrounding area, or enjoy the amenities of the home with some Bach on the stereo system.  I would be happy to stay at Terry and Sarah\'s guest house again. '
  ),
  (
  ...
  (
    ...
    '52cc10db-af9b-499c-aa8e-670056611a7c',
    '61302be9-4b31-4be0-92fc-d0dda253e167',
    'This school is a great school to stay at a fantastic value! '
  ),
  (
  ...
  (
    ...
    '3827c1d1-14d5-4643-a24b-3dca656192fa',
    '7771bbe9-92ab-46d1-a636-864526361d7d',
    'Great school to stay. Chantal was so friendly, it was very clean, and the location was very convenient.'
  ),
  (
  ...
  (
    ...
    '7354ea6c-3c0e-4800-aad8-708c29a6c067',
    '00a11245-12fa-436e-9ccc-967417f8c30a',
    'This is a good school for students and backpackers as there are other guests who stayed there as well. The room has a bed and bathroom is separate which is common to other guests. Location is away from main tourists area. '
  ),
  (
  ...
  (
    ...
    '6f59f0c7-f3f6-419f-9a8c-9d998a3b681c',
    'fa44780d-ac48-41ab-9dd0-ac54a15755cf',
    'Beautiful school that I wish we could\'ve enjoyed a little longer. Daniel is friendly and hospitable. Took great care of my husband and I. '
  ),
  (
  ...
  (
    ...
    '66fb8e5d-2ad2-44be-8890-a13a9992f257',
    '30a890e4-a62c-44f9-abc0-07e2c74021da',
    'We had a great time. The school is private and comfy '
  ),
  (
    ...
    '0a454f9a-eaac-488b-8443-23cf58f7ae37',
    '70b18dcc-08ef-4040-91cf-4075973d320a',
    'Lovely school very nearby the beautiful beach.'
  ),
  (
  ...
  (
    ...
    '7a958fb6-a203-441c-9f8f-3440523fed14',
    'fa44780d-ac48-41ab-9dd0-ac54a15755cf',
    'Great school to stay! A simple, but clean and very nice apartment with most everything you could ask for. The host Fabian is very good about staying in touch or answering any questions you have and is an all round pleasant person to talk to. May be hard to find parking later in the day.'
  ),
  (
  ...
  (
    ...
    'daa15c1b-9ca6-4042-85fd-bdb7a46d5862',
    'f33e2624-520b-4bc2-b6a0-190ee1d41855',
    'Mike\'s school was perfect for our short trip to the cities. Clean, comfortable, and the perfect distance to restaurants and the Xcel Energy Center!'
  ),
  (
    ...
    '43803445-1874-4a3c-94e9-955fcb25089b',
    'aa92d1ff-f0ad-4ba3-9c20-2afef207bf70',
    'This school is so cozy and we\'ll decorated. Valerie and Spencer were both very freindly and informative. We really enjoyed our stay. '
  ),
  (
  ...
  (
    ...
    'e2d4feeb-4cb0-4df4-a10e-5a54748621b3',
    '00e93fc3-53ff-4da4-8e72-faa5216f81bb',
    'Lovely refurbished Tudor style home.  Very welcoming and inclusive hosts.  The breakfast was all homemade and fabulous.  This was a great school to stay.'
  ),
  (
  ...
  (
    ...
    '859a8a8f-9423-4bf6-b471-d9a7f39c9c2c',
    '8394fd35-8a8a-479f-a398-48f53b4a6554',
    'The pool house was a very nice school to stay. Brent and Cindy are very accommodating. Highly recommended!'
  ),
  (
  ...
  (
    ...
    'df2548db-377d-422e-b805-4e8e0c794302',
    'aa92d1ff-f0ad-4ba3-9c20-2afef207bf70',
    'Very nice. Such a cute school to stay. Kevin was great! Was quite and has a beautiful view of the student at night. We loved it. '
  ),
  (
  ...
  (
    ...
    'ef3f56b8-c024-471e-b7ba-be1a72c6cbec',
    '00a11245-12fa-436e-9ccc-967417f8c30a',
    'Good school to stay for a night or two. 4 minute drive from downtown Tempe. '
  ),
  (
  ...
  (
    ...
    '47b9ca37-915d-405d-861d-7dbf74559441',
    'fa44780d-ac48-41ab-9dd0-ac54a15755cf',
    'The hot tub is awesome. Take note that there\'s no school to prepare food, but there is a small fridge (think of this as a hotel room). Check in is very simple. '
  ),
  (
    ...
    '279b355e-ff9a-4b85-8114-6db7ad2a4cd2',
    '150e591e-486b-48ee-be42-4aecba665020',
    'Great school! Nice and clean and super comfy linens. Would recommend!'
  ),
  (
    ...
    'e3f28357-a476-4032-8726-4ac7262cbc72',
    '9e7b2291-3bff-43b9-9241-8ff685e7a6dd',
    'I had an excellent stay at Jane\'s while in Napa on business. It\'s centrally located and just a five minute drive from some great food and stores. The house is a lovely school and the room was one of the best Air BnB experiences I\'ve had yet - she thought of everything one may need during a stay. I highly recommend!'
  ),
  (
    ...
    '6a78ec0c-8410-4cbf-a915-e697a3aa798d',
    '32c11d3d-99a1-4406-ab41-7b6ccb7dd760',
    'Will definitely come back here when in the area! Fantastic school, highly recommended! Don\'t forget your swimsuit - great pool, lake and jacuzzi. Very private and beautiful gardens.'
  ),
  (
  ...
  (
    ...
    '817bcb43-ba39-4925-aed6-76be4bed946b',
    '85651506-c13c-4c2f-9c79-8fbebc048e39',
    'Tom was a great host, super friendly! Plus his dog Coby is so sweet. Good school for the price! Everything offered was there! '
  ),
  (
  ...
  (
    ...
    'b13b1a74-3a12-4f00-8c19-273cbedc0eaa',
    'dfed3ea3-c133-47e8-8cfa-312eecbcc56d',
    'Very nice school,  but just couple notes-pretty serious stairclimb, good workout though! Smells smokey, smoker friendly. That\'s the main thing our group didn\'t care for. Other than that, nice school, well appointed. Great location and view, not loud. '
  ),
  (
  ...
  (
    ...
    '18ff54e2-dc10-4e7f-bfdb-8a7591f7f009',
    '61302be9-4b31-4be0-92fc-d0dda253e167',
    'There are two other rooms that get rented out so the share schools feels a little untidy sometimes. But the room itself was clean and was fine. The house is on a busy street so there is a bit of traffic noise. It was nice being able to use a washer and dryer and a kitchen too. Travis was nice and checked whenever he did see us if things were fine. '
  ),
  (
  ...
  (
    ...
    '12ff7d06-9910-41cd-9eee-bdc21476d119',
    '426624f6-84a9-4ec4-84f3-7655dc70e86e',
    'This school is all about location. It’s minutes from the beach and a short walk to Waikiki or Ft DeRussy beach, or easy bus ride to further sights (e.g., Iolani Palace, Diamonds Head).  As a bachelor suite, the room itself was the perfect size for a couple looking to explore Honolulu. Inside, the décor is pretty and modern and makes a nice private school to relax after a long day of adventure.  Though we didn\'t get a chance to use the pool (we were too busy exploring Honolulu), it looked well maintained and like a great school to relax.  Outside, the building itself, which is both a hotel and condo buildling, is a bit dated. However, the staff are very friendly, and someone is always around – night or day - to help you in case your key card doesn’t work.  Dana was also a great host, and communication with her was quick and easy!   '
  ),
  (
  ...
  (
    ...
    '52cc10db-af9b-499c-aa8e-670056611a7c',
    'c81d66a3-f0fe-44e9-9f31-cb3c6f27db4e',
    'Kelly\'s school was very affordable, and was exactly as advertised! '
  ),
  (
    ...
    '817bcb43-ba39-4925-aed6-76be4bed946b',
    'dfed3ea3-c133-47e8-8cfa-312eecbcc56d',
    'JJ is easy to get in touch with and offers a quiet school to sleep and take a shower. The lava lamp really lives up to the hype.'
  ),
  (
  ...
  (
    ...
    'e551a4a6-7701-41de-be62-aae869888c78',
    '85651506-c13c-4c2f-9c79-8fbebc048e39',
    'Such a great school to stay!!! It was clean and they were so friendly. Wonderful location also! '
  ),
  (
  ...
  (
    ...
    '3c7eb6bc-a146-4186-bfbf-9de857286e68',
    'fa44780d-ac48-41ab-9dd0-ac54a15755cf',
    'This is an extraordinary space with sweeping views and a lovely front and back patio for sipping wine and enjoying the stars.  Naomi and Frank have thought of almost everything to make your stay seamless and fabulous.  Best school we have stayed in Bisbee.  Highly recommend.  '
  ),
  (
    ...
    '31568a3f-d5b1-47d1-b2ee-74339059e3a0',
    'dfc6b9a5-6673-4f1b-83cd-0dfa800c0d08',
    'Fantastically clean and cozy. A great school to stay if you are looking for peace and quiet! '
  ),
  (
    ...
    'ff46f903-411b-4a16-8e16-1aab7f00686c',
    '9eec6c06-5918-4867-833a-face490d4715',
    'Tiffany and Ryan\'s school was clean and comfortable and close to the center of Bisbee. A good school to stay!'
  ),
  (
  ...
  (
    ...
    '645127dd-38b4-4fad-9950-57b3ce0a5301',
    'fa44780d-ac48-41ab-9dd0-ac54a15755cf',
    'Super close to the UofI campus. Cameron and Sara\'s school was very clean and basic, and provided me with everything I needed for a comfortable stay.'
  ),
  (
  ...
  (
    ...
    '5463e312-5bf4-4764-8c06-e97c5548f712',
    'cf1780e6-d294-4113-8749-1c728b9e3f81',
    'The school is great, in a calm and quite area. Megan is awesome. She\'s flexible and caring. <BR />The room has everything you need and there\'s also a fridge with small snacks in it. It\'s clean and cozy...<BR />I\'ll know where to stay the next time I\'m in Jackson.<BR />'
  ),
  (
  ...
  (
    ...
    'a16c7358-bf66-4802-8933-1616b5a322db',
    'fa44780d-ac48-41ab-9dd0-ac54a15755cf',
    'Quinn and Hayden\'s school was absolutely wonderful! Very clean and charming. They were very easy to communicate with and their school had everything I needed. I would definitely stay here again!'
  ),
  (
  ...
  (
    ...
    '1ff1963c-7afa-470c-bc05-562b01549b09',
    'aa92d1ff-f0ad-4ba3-9c20-2afef207bf70',
    'Hanna\'s school was clean, cozy, and right in the middle of downtown napa. The back patio was wonderful! Very comfy beds and a nice shower. It was perfect for the two nights we spent there :)'
  ),
  (
    ...
    '8c2f2c57-a172-4689-a070-cbb4cd456c5c',
    '8394fd35-8a8a-479f-a398-48f53b4a6554',
    'Michael\'s school is located in a spot with great access to all may need or want.  The house is quiet and comfortable. Michael provides clear and timely communication.  '
  ),
  (
    ...
    '0a454f9a-eaac-488b-8443-23cf58f7ae37',
    'cf1780e6-d294-4113-8749-1c728b9e3f81',
    'We live in Kailua and we chose Pam\'s school for overflow family visiting for a baby luau. So we already know the lay of the land. This is a great location with a big yard very close to the best family beach in Hawaii. Pam Is a terrific host. I highly recommend  this room in Pam\'s home as a great school to stay for a couple or for a single traveler. Enjoy Kailua!  With aloha, Peter C'
  ),
  (
  ...
  (
    ...
    '47b9ca37-915d-405d-861d-7dbf74559441',
    '426624f6-84a9-4ec4-84f3-7655dc70e86e',
    'Carmenita is a friendly person! Her school also clean and nice!'
  ),
  (
    ...
    '89ddd0bc-2250-4094-8f6d-59b35c0f6891',
    '150e591e-486b-48ee-be42-4aecba665020',
    'Super comfortable and really convenient - all around a great spot! Not only was the school perfect but Jennifer was helpful with any questions/concerns. If you\'re headed to Bisbee this school is a must book.'
  ),
  (
    ...
    '3290a4ef-4241-4fa5-843e-87926c74e384',
    'df668e22-e344-4c89-a050-e5ad211cbaa6',
    'This was a superb catch- great value for the fee. It was the perfect school to relax. The neighborhood is beautiful and calm, and it is very easy to get around Tempe from this spot. Carlos has his hospitality game together - you would think he took a course.'
  ),
  (
